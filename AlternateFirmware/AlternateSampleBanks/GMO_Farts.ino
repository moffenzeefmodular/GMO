...
#include <samples/Wavetables/fartOne_int8.h> // Table for Sample
#include <samples/Wavetables/fartTwo_int8.h> // Table for Sample 
#include <samples/Wavetables/fartThree_int8.h> // Table for Sample 
#include <samples/Wavetables/fartFour_int8.h> // Table for Sample 
#include <samples/Wavetables/fartFive_int8.h> // Table for Sample 
#include <samples/Wavetables/fartSix_int8.h> // Table for Sample
#include <samples/Wavetables/fartSeven_int8.h> // Table for Sample 

#define CONTROL_RATE 256 // powers of 2 please 

Sample <FARTONE_NUM_CELLS, AUDIO_RATE> aSample(FARTONE_DATA); // create the wavetable template 
...
*/
  ...
  */
  ...
  switch (sampleSelect) {
    case 1:
      aSample.setTable(FARTONE_DATA); // change the current wavetable
      CURRENT_TABLE = FARTONE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 2:
      aSample.setTable(FARTTWO_DATA); // change the current wavetable
      CURRENT_TABLE = FARTTWO_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 3:
      aSample.setTable(FARTTHREE_DATA); // change the current wavetable
      CURRENT_TABLE = FARTTHREE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 4:
      aSample.setTable(FARTFOUR_DATA); // change the current wavetable
      CURRENT_TABLE = FARTFOUR_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 5:
      aSample.setTable(FARTFIVE_DATA); // change the current wavetable
      CURRENT_TABLE = FARTFIVE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 6:
      aSample.setTable(FARTSIX_DATA); // change the current wavetable
      CURRENT_TABLE = FARTSIX_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 7:
      aSample.setTable(FARTSEVEN_DATA); // change the current wavetable
      CURRENT_TABLE = FARTSEVEN_NUM_CELLS; // set the wavetable length to current wavetable
      break;
