...
#include <samples/Wavetables/mouthone_int8.h> // Table for Sample
#include <samples/Wavetables/mouthtwo_int8.h> // Table for Sample 
#include <samples/Wavetables/mouththree_int8.h> // Table for Sample 
#include <samples/Wavetables/mouthfour_int8.h> // Table for Sample 
#include <samples/Wavetables/mouthfive_int8.h> // Table for Sample 
#include <samples/Wavetables/mouthsix_int8.h> // Table for Sample 
#include <samples/Wavetables/mouthseven_int8.h> // Table for Sample 
#include <samples/Wavetables/moutheight_int8.h> // Table for Sample 

#define CONTROL_RATE 256 // powers of 2 please 

Sample <MOUTHONE_NUM_CELLS, AUDIO_RATE> aSample(MOUTHONE_DATA); // create the wavetable template 
...
*/
  ...
  */
  ...
  pitch = mapfloat(pitchMath, 1, 1023, 0.01, 20.0); // map from 0.01% to triple speed
  ...
  */
  ...
  switch (sampleSelect) {
    case 1:
      aSample.setTable(MOUTHONE_DATA); // change the current wavetable
      CURRENT_TABLE = MOUTHONE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 2:
      aSample.setTable(MOUTHTWO_DATA); // change the current wavetable
      CURRENT_TABLE = MOUTHTWO_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 3:
      aSample.setTable(MOUTHTHREE_DATA); // change the current wavetable
      CURRENT_TABLE = MOUTHTHREE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 4:
      aSample.setTable(MOUTHFOUR_DATA); // change the current wavetable
      CURRENT_TABLE = MOUTHFOUR_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 5:
      aSample.setTable(MOUTHFIVE_DATA); // change the current wavetable
      CURRENT_TABLE = MOUTHFIVE_NUM_CELLS; // set the wavetable length to current wavetable
      break;
      
    case 6:
      aSample.setTable(MOUTHSIX_DATA); // change the current wavetable
      CURRENT_TABLE = MOUTHSIX_NUM_CELLS; // set the wavetable length to current wavetable
      break;
      
    case 7:
      aSample.setTable(MOUTHSEVEN_DATA); // change the current wavetable
      CURRENT_TABLE = MOUTHSEVEN_NUM_CELLS; // set the wavetable length to current wavetable
      break;
      
    case 8:
      aSample.setTable(MOUTHEIGHT_DATA); // change the current wavetable
      CURRENT_TABLE = MOUTHEIGHT_NUM_CELLS; // set the wavetable length to current wavetable
      break;
