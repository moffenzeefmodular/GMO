...
#include <samples/wavetables/mtfivehundredOne_int8.h> // Table for Sample
#include <samples/wavetables/mtfivehundredTwo_int8.h> // Table for Sample 
#include <samples/wavetables/mtfivehundredThree_int8.h> // Table for Sample 
#include <samples/wavetables/mtfivehundredFour_int8.h> // Table for Sample 
#include <samples/wavetables/mtfivehundredFive_int8.h> // Table for Sample
#include <samples/wavetables/mtfivehundredSix_int8.h> // Table for Sample 
#include <samples/wavetables/mtfivehundredSeven_int8.h> // Table for Sample 
#include <samples/wavetables/mtfivehundredEight_int8.h> // Table for Sample 
#include <samples/wavetables/mtfivehundredNine_int8.h> // Table for Sample 
#include <samples/wavetables/mtfivehundredTen_int8.h> // Table for Sample 


#define CONTROL_RATE 256 // powers of 2 please 

Sample <MTFIVEHUNDREDONE_NUM_CELLS, AUDIO_RATE> aSample(MTFIVEHUNDREDONE_DATA); // create the wavetable template 
...
*/
  ...
  */
  ...
  sampleSelect = map(sampleMath, 1, 1023, 1, 11); 
  ...
  */
  ...
  switch (sampleSelect) {
    case 1:
      aSample.setTable(MTFIVEHUNDREDONE_DATA); // change the current wavetable
      CURRENT_TABLE = MTFIVEHUNDREDONE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 2:
      aSample.setTable(MTFIVEHUNDREDTWO_DATA); // change the current wavetable
      CURRENT_TABLE = MTFIVEHUNDREDTWO_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 3:
      aSample.setTable(MTFIVEHUNDREDTHREE_DATA); // change the current wavetable
      CURRENT_TABLE = MTFIVEHUNDREDTHREE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 4:
      aSample.setTable(MTFIVEHUNDREDFOUR_DATA); // change the current wavetable
      CURRENT_TABLE = MTFIVEHUNDREDFOUR_NUM_CELLS; // set the wavetable length to current wavetable
      break;
      
    case 5:
      aSample.setTable(MTFIVEHUNDREDFIVE_DATA); // change the current wavetable
      CURRENT_TABLE = MTFIVEHUNDREDFIVE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 6:
      aSample.setTable(MTFIVEHUNDREDSIX_DATA); // change the current wavetable
      CURRENT_TABLE = MTFIVEHUNDREDSIX_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 7:
      aSample.setTable(MTFIVEHUNDREDSEVEN_DATA); // change the current wavetable
      CURRENT_TABLE = MTFIVEHUNDREDSEVEN_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 8:
      aSample.setTable(MTFIVEHUNDREDEIGHT_DATA); // change the current wavetable
      CURRENT_TABLE = MTFIVEHUNDREDEIGHT_NUM_CELLS; // set the wavetable length to current wavetable
      break;  

    case 9:
      aSample.setTable(MTFIVEHUNDREDNINE_DATA); // change the current wavetable
      CURRENT_TABLE = MTFIVEHUNDREDNINE_NUM_CELLS; // set the wavetable length to current wavetable
      break;   
      
    case 10:
      aSample.setTable(MTFIVEHUNDREDTEN_DATA); // change the current wavetable
      CURRENT_TABLE = MTFIVEHUNDREDTEN_NUM_CELLS; // set the wavetable length to current wavetable
      break;     
