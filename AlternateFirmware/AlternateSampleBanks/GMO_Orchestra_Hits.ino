...
#include <samples/Wavetables/orchOne_int8.h> // Table for Sample
#include <samples/Wavetables/orchTwo_int8.h> // Table for Sample 
#include <samples/Wavetables/orchThree_int8.h> // Table for Sample 
#include <samples/Wavetables/orchFour_int8.h> // Table for Sample 
#include <samples/Wavetables/orchFive_int8.h> // Table for Sample 
#include <samples/Wavetables/orchSix_int8.h> // Table for Sample
#include <samples/Wavetables/orchSeven_int8.h> // Table for Sample 

#define CONTROL_RATE 256 // powers of 2 please 

Sample <ORCHONE_NUM_CELLS, AUDIO_RATE> aSample(ORCHONE_DATA); // create the wavetable template 
...
*/
  ...
  */
  ...
  pitch = mapfloat(pitchMath, 1, 1023, 0.5, 3.0); // map from 0.01% to triple speed
  ...
  */
  ...
  switch (sampleSelect) {
    case 1:
      aSample.setTable(ORCHONE_DATA); // change the current wavetable
      CURRENT_TABLE = ORCHONE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 2:
      aSample.setTable(ORCHTWO_DATA); // change the current wavetable
      CURRENT_TABLE = ORCHTWO_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 3:
      aSample.setTable(ORCHTHREE_DATA); // change the current wavetable
      CURRENT_TABLE = ORCHTHREE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 4:
      aSample.setTable(ORCHFOUR_DATA); // change the current wavetable
      CURRENT_TABLE = ORCHFOUR_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 5:
      aSample.setTable(ORCHFIVE_DATA); // change the current wavetable
      CURRENT_TABLE = ORCHFIVE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 6:
      aSample.setTable(ORCHSIX_DATA); // change the current wavetable
      CURRENT_TABLE = ORCHSIX_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 7:
      aSample.setTable(ORCHSEVEN_DATA); // change the current wavetable
      CURRENT_TABLE = ORCHSEVEN_NUM_CELLS; // set the wavetable length to current wavetable
      break;
