...
#include <samples/Wavetables/jazzOne_int8.h> // Table for Sample
#include <samples/Wavetables/jazzTwo_int8.h> // Table for Sample 
#include <samples/Wavetables/jazzThree_int8.h> // Table for Sample 
#include <samples/Wavetables/jazzFour_int8.h> // Table for Sample 
#include <samples/Wavetables/jazzFive_int8.h> // Table for Sample 
#include <samples/Wavetables/jazzSix_int8.h> // Table for Sample
#include <samples/Wavetables/jazzSeven_int8.h> // Table for Sample 
#include <samples/Wavetables/jazzEight_int8.h> // Table for Sample 
#include <samples/Wavetables/jazzNine_int8.h> // Table for Sample 
#include <samples/Wavetables/jazzTen_int8.h> // Table for Sample 
#include <samples/Wavetables/jazzEleven_int8.h> // Table for Sample 
#include <samples/Wavetables/jazzTwelve_int8.h> // Table for Sample 
#include <samples/Wavetables/jazzThirteen_int8.h> // Table for Sample 
#include <samples/Wavetables/jazzFourteen_int8.h> // Table for Sample 
#include <samples/Wavetables/jazzFifteen_int8.h> // Table for Sample 
#include <samples/Wavetables/jazzSixteen_int8.h> // Table for Sample 
#include <samples/Wavetables/jazzSeventeen_int8.h> // Table for Sample 


#define CONTROL_RATE 256 // powers of 2 please 

Sample <JAZZONE_NUM_CELLS, AUDIO_RATE> aSample(JAZZONE_DATA); // create the wavetable template 
...
int trigState = 0; // variable to hold current trig state
int lastTrigState = 0; // variable to hold previous trig state
...
void setup() {
  ...
  pinMode(4, INPUT); // Enable pin 4 as input for Looping switch 
...
*/
  ...
  if (trigState != lastTrigState && trigState == HIGH) { 
   ...
   lastTrigState = trigState;  // set the last trigger state to the current trigger state because we are done with the reading 
...
*/
  ...
  */
  ...
  pitch = mapfloat(pitchMath, 1, 1023, 2.0, 5.0); // map from 0.01% to triple speed
  ...
  */
  ...
  sampleSelect = map(sampleMath, 1, 1023, 1, 18); 
  ...
  */
  ...
  switch (sampleSelect) {
    case 1:
      aSample.setTable(JAZZONE_DATA); // change the current wavetable
      CURRENT_TABLE = JAZZONE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 2:
      aSample.setTable(JAZZTWO_DATA); // change the current wavetable
      CURRENT_TABLE = JAZZTWO_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 3:
      aSample.setTable(JAZZTHREE_DATA); // change the current wavetable
      CURRENT_TABLE = JAZZTHREE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 4:
      aSample.setTable(JAZZFOUR_DATA); // change the current wavetable
      CURRENT_TABLE = JAZZFOUR_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 5:
      aSample.setTable(JAZZFIVE_DATA); // change the current wavetable
      CURRENT_TABLE = JAZZFIVE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 6:
      aSample.setTable(JAZZSIX_DATA); // change the current wavetable
      CURRENT_TABLE = JAZZSIX_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 7:
      aSample.setTable(JAZZSEVEN_DATA); // change the current wavetable
      CURRENT_TABLE = JAZZSEVEN_NUM_CELLS; // set the wavetable length to current wavetable
      break;
      
    case 8:
      aSample.setTable(JAZZEIGHT_DATA); // change the current wavetable
      CURRENT_TABLE = JAZZEIGHT_NUM_CELLS; // set the wavetable length to current wavetable
      break;
      
    case 9:
      aSample.setTable(JAZZNINE_DATA); // change the current wavetable
      CURRENT_TABLE = JAZZNINE_NUM_CELLS; // set the wavetable length to current wavetable
      break;
      
    case 10:
      aSample.setTable(JAZZTEN_DATA); // change the current wavetable
      CURRENT_TABLE = JAZZTEN_NUM_CELLS; // set the wavetable length to current wavetable
      break;
      
    case 11:
      aSample.setTable(JAZZELEVEN_DATA); // change the current wavetable
      CURRENT_TABLE = JAZZELEVEN_NUM_CELLS; // set the wavetable length to current wavetable
      break;
      
    case 12:
      aSample.setTable(JAZZTWELVE_DATA); // change the current wavetable
      CURRENT_TABLE = JAZZTWELVE_NUM_CELLS; // set the wavetable length to current wavetable
      break;
      
    case 13:
      aSample.setTable(JAZZTHIRTEEN_DATA); // change the current wavetable
      CURRENT_TABLE = JAZZTHIRTEEN_NUM_CELLS; // set the wavetable length to current wavetable
      break;
      
    case 14:
      aSample.setTable(JAZZFOURTEEN_DATA); // change the current wavetable
      CURRENT_TABLE = JAZZFOURTEEN_NUM_CELLS; // set the wavetable length to current wavetable
      break;      
      
    case 15:
      aSample.setTable(JAZZFIFTEEN_DATA); // change the current wavetable
      CURRENT_TABLE = JAZZFIFTEEN_NUM_CELLS; // set the wavetable length to current wavetable
      break;   

    case 16:
      aSample.setTable(JAZZSIXTEEN_DATA); // change the current wavetable
      CURRENT_TABLE = JAZZSIXTEEN_NUM_CELLS; // set the wavetable length to current wavetable
      break;   

    case 17:
      aSample.setTable(JAZZSEVENTEEN_DATA); // change the current wavetable
      CURRENT_TABLE = JAZZSEVENTEEN_NUM_CELLS; // set the wavetable length to current wavetable
      break;         
  }
