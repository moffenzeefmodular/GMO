...
#include <samples/Wavetables/sasa_int8.h> // Table for Sample
#include <samples/Wavetables/sasb_int8.h> // Table for Sample 
#include <samples/Wavetables/sasc_int8.h> // Table for Sample 
#include <samples/Wavetables/sasd_int8.h> // Table for Sample 
#include <samples/Wavetables/sase_int8.h> // Table for Sample 
#include <samples/Wavetables/sasf_int8.h> // Table for Sample
#include <samples/Wavetables/sasg_int8.h> // Table for Sample 
#include <samples/Wavetables/sash_int8.h> // Table for Sample

#define CONTROL_RATE 256 // powers of 2 please 

Sample <SASA_NUM_CELLS, AUDIO_RATE> aSample(SASA_DATA); // create the wavetable template 
...
*/
  ...
  */
  ...
  switch (sampleSelect) {
    case 1:
      aSample.setTable(SASA_DATA); // change the current wavetable
      CURRENT_TABLE = SASA_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 2:
      aSample.setTable(SASB_DATA); // change the current wavetable
      CURRENT_TABLE = SASB_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 3:
      aSample.setTable(SASC_DATA); // change the current wavetable
      CURRENT_TABLE = SASC_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 4:
      aSample.setTable(SASD_DATA); // change the current wavetable
      CURRENT_TABLE = SASD_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 5:
      aSample.setTable(SASE_DATA); // change the current wavetable
      CURRENT_TABLE = SASE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 6:
      aSample.setTable(SASF_DATA); // change the current wavetable
      CURRENT_TABLE = SASF_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 7:
      aSample.setTable(SASG_DATA); // change the current wavetable
      CURRENT_TABLE = SASG_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 8:
      aSample.setTable(SASH_DATA); // change the current wavetable
      CURRENT_TABLE = SASH_NUM_CELLS; // set the wavetable length to current wavetable
      break;
  }
