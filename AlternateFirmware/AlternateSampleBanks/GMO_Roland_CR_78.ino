...
#include <samples/Wavetables/rolandcrOne_int8.h> // Table for Sample
#include <samples/Wavetables/rolandcrTwo_int8.h> // Table for Sample 
#include <samples/Wavetables/rolandcrThree_int8.h> // Table for Sample 
#include <samples/Wavetables/rolandcrFour_int8.h> // Table for Sample 
#include <samples/Wavetables/rolandcrFive_int8.h> // Table for Sample 
#include <samples/Wavetables/rolandcrSix_int8.h> // Table for Sample
#include <samples/Wavetables/rolandcrSeven_int8.h> // Table for Sample 
#include <samples/Wavetables/rolandcrEight_int8.h> // Table for Sample 

#define CONTROL_RATE 256 // powers of 2 please 

Sample <ROLANDCRONE_NUM_CELLS, AUDIO_RATE> aSample(ROLANDCRONE_DATA); // create the wavetable template 
...
*/
  ...
  */
  ...
  switch (sampleSelect) {
    case 1:
      aSample.setTable(ROLANDCRONE_DATA); // change the current wavetable
      CURRENT_TABLE = ROLANDCRONE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 2:
      aSample.setTable(ROLANDCRTWO_DATA); // change the current wavetable
      CURRENT_TABLE = ROLANDCRTWO_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 3:
      aSample.setTable(ROLANDCRTHREE_DATA); // change the current wavetable
      CURRENT_TABLE = ROLANDCRTHREE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 4:
      aSample.setTable(ROLANDCRFOUR_DATA); // change the current wavetable
      CURRENT_TABLE = ROLANDCRFOUR_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 5:
      aSample.setTable(ROLANDCRFIVE_DATA); // change the current wavetable
      CURRENT_TABLE = ROLANDCRFIVE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 6:
      aSample.setTable(ROLANDCRSIX_DATA); // change the current wavetable
      CURRENT_TABLE = ROLANDCRSIX_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 7:
      aSample.setTable(ROLANDCRSEVEN_DATA); // change the current wavetable
      CURRENT_TABLE = ROLANDCRSEVEN_NUM_CELLS; // set the wavetable length to current wavetable
      break;
      
    case 8:
      aSample.setTable(ROLANDCREIGHT_DATA); // change the current wavetable
      CURRENT_TABLE = ROLANDCREIGHT_NUM_CELLS; // set the wavetable length to current wavetable
      break;
  }
