...
#include <samples/Wavetables/glassone_int8.h> // Table for Sample
#include <samples/Wavetables/glasstwo_int8.h> // Table for Sample 
#include <samples/Wavetables/glassthree_int8.h> // Table for Sample 
#include <samples/Wavetables/glassfour_int8.h> // Table for Sample 
#include <samples/Wavetables/glassfive_int8.h> // Table for Sample 
#include <samples/Wavetables/glasssix_int8.h> // Table for Sample 
#include <samples/Wavetables/glassseven_int8.h> // Table for Sample 
#include <samples/Wavetables/glasseight_int8.h> // Table for Sample 

#define CONTROL_RATE 256 // powers of 2 please 

Sample <GLASSONE_NUM_CELLS, AUDIO_RATE> aSample(GLASSONE_DATA); // create the wavetable template 
...
*/
  ...
  */
  ...
  switch (sampleSelect) {
    case 1:
      aSample.setTable(GLASSONE_DATA); // change the current wavetable
      CURRENT_TABLE = GLASSONE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 2:
      aSample.setTable(GLASSTWO_DATA); // change the current wavetable
      CURRENT_TABLE = GLASSTWO_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 3:
      aSample.setTable(GLASSTHREE_DATA); // change the current wavetable
      CURRENT_TABLE = GLASSTHREE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 4:
      aSample.setTable(GLASSFOUR_DATA); // change the current wavetable
      CURRENT_TABLE = GLASSFOUR_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 5:
      aSample.setTable(GLASSFIVE_DATA); // change the current wavetable
      CURRENT_TABLE = GLASSFIVE_NUM_CELLS; // set the wavetable length to current wavetable
      break;
      
    case 6:
      aSample.setTable(GLASSSIX_DATA); // change the current wavetable
      CURRENT_TABLE = GLASSSIX_NUM_CELLS; // set the wavetable length to current wavetable
      break;
      
    case 7:
      aSample.setTable(GLASSSEVEN_DATA); // change the current wavetable
      CURRENT_TABLE = GLASSSEVEN_NUM_CELLS; // set the wavetable length to current wavetable
      break;
      
    case 8:
      aSample.setTable(GLASSEIGHT_DATA); // change the current wavetable
      CURRENT_TABLE = GLASSEIGHT_NUM_CELLS; // set the wavetable length to current wavetable
      break;
