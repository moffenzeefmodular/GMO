...
#include <samples/Wavetables/casioskOne_int8.h> // Table for Sample
#include <samples/Wavetables/casioskTwo_int8.h> // Table for Sample 
#include <samples/Wavetables/casioskThree_int8.h> // Table for Sample 
#include <samples/Wavetables/casioskFour_int8.h> // Table for Sample 
#include <samples/Wavetables/casioskFive_int8.h> // Table for Sample 
#include <samples/Wavetables/casioskSix_int8.h> // Table for Sample

#define CONTROL_RATE 256 // powers of 2 please 

Sample <CASIOSKONE_NUM_CELLS, AUDIO_RATE> aSample(CASIOSKONE_DATA); // create the wavetable template 
...
*/
  ...
  */
  ...
  switch (sampleSelect) {
    case 1:
      aSample.setTable(CASIOSKONE_DATA); // change the current wavetable
      CURRENT_TABLE = CASIOSKONE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 2:
      aSample.setTable(CASIOSKTWO_DATA); // change the current wavetable
      CURRENT_TABLE = CASIOSKTWO_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 3:
      aSample.setTable(CASIOSKTHREE_DATA); // change the current wavetable
      CURRENT_TABLE = CASIOSKTHREE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 4:
      aSample.setTable(CASIOSKFOUR_DATA); // change the current wavetable
      CURRENT_TABLE = CASIOSKFOUR_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 5:
      aSample.setTable(CASIOSKFIVE_DATA); // change the current wavetable
      CURRENT_TABLE = CASIOSKFIVE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 6:
      aSample.setTable(CASIOSKSIX_DATA); // change the current wavetable
      CURRENT_TABLE = CASIOSKSIX_NUM_CELLS; // set the wavetable length to current wavetable
      break;
