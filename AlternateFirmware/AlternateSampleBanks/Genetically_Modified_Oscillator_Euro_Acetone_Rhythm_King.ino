...
#include <samples/wavetables/acetoneOne_int8.h> // Table for Sample
#include <samples/wavetables/acetoneTwo_int8.h> // Table for Sample 
#include <samples/wavetables/acetoneThree_int8.h> // Table for Sample 
#include <samples/wavetables/acetoneFour_int8.h> // Table for Sample 
#include <samples/wavetables/acetoneFive_int8.h> // Table for Sample 
#include <samples/wavetables/acetoneSix_int8.h> // Table for Sample
#include <samples/wavetables/acetoneSeven_int8.h> // Table for Sample 
#include <samples/wavetables/acetoneEight_int8.h> // Table for Sample
#include <samples/wavetables/acetoneNine_int8.h> // Table for Sample

#define CONTROL_RATE 256 // powers of 2 please 

Sample <ACETONEONE_NUM_CELLS, AUDIO_RATE> aSample(ACETONEONE_DATA); // create the wavetable template 
...
*/
  ...
  */
  ...
  pitch = mapfloat(pitchMath, 1, 1023, 0.5, 5.0); // map from 0.01% to triple speed
  ...
  */
  ...
  sampleSelect = map(sampleMath, 1, 1023, 1, 10); 
  ...
  */
  ...
  switch (sampleSelect) {
    case 1:
      aSample.setTable(ACETONEONE_DATA); // change the current wavetable
      CURRENT_TABLE = ACETONEONE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 2:
      aSample.setTable(ACETONETWO_DATA); // change the current wavetable
      CURRENT_TABLE = ACETONETWO_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 3:
      aSample.setTable(ACETONETHREE_DATA); // change the current wavetable
      CURRENT_TABLE = ACETONETHREE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 4:
      aSample.setTable(ACETONEFOUR_DATA); // change the current wavetable
      CURRENT_TABLE = ACETONEFOUR_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 5:
      aSample.setTable(ACETONEFIVE_DATA); // change the current wavetable
      CURRENT_TABLE = ACETONEFIVE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 6:
      aSample.setTable(ACETONESIX_DATA); // change the current wavetable
      CURRENT_TABLE = ACETONESIX_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 7:
      aSample.setTable(ACETONESEVEN_DATA); // change the current wavetable
      CURRENT_TABLE = ACETONESEVEN_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 8:
      aSample.setTable(ACETONEEIGHT_DATA); // change the current wavetable
      CURRENT_TABLE = ACETONEEIGHT_NUM_CELLS; // set the wavetable length to current wavetable
      break;
      
    case 9:
      aSample.setTable(ACETONENINE_DATA); // change the current wavetable
      CURRENT_TABLE = ACETONENINE_NUM_CELLS; // set the wavetable length to current wavetable
      break;
