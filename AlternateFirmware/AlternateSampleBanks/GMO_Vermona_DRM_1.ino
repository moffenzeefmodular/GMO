...
#include <samples/Wavetables/drmOne_int8.h> // Table for Sample
#include <samples/Wavetables/drmTwo_int8.h> // Table for Sample 
#include <samples/Wavetables/drmThree_int8.h> // Table for Sample 
#include <samples/Wavetables/drmFour_int8.h> // Table for Sample 
#include <samples/Wavetables/drmFive_int8.h> // Table for Sample 
#include <samples/Wavetables/drmSix_int8.h> // Table for Sample
#include <samples/Wavetables/drmSeven_int8.h> // Table for Sample 
#include <samples/Wavetables/drmEight_int8.h> // Table for Sample 
#include <samples/Wavetables/drmNine_int8.h> // Table for Sample 
#include <samples/Wavetables/drmTen_int8.h> // Table for Sample 


#define CONTROL_RATE 256 // powers of 2 please 

Sample <DRMONE_NUM_CELLS, AUDIO_RATE> aSample(DRMONE_DATA); // create the wavetable template 
...
*/
  ...
  */
  ...
  pitch = mapfloat(pitchMath, 1, 1023, 10.0, 20.0); // map from 0.01% to triple speed
  ...
  */
  ...
  switch (sampleSelect) {
    case 1:
      aSample.setTable(DRMONE_DATA); // change the current wavetable
      CURRENT_TABLE = DRMONE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 2:
      aSample.setTable(DRMTWO_DATA); // change the current wavetable
      CURRENT_TABLE = DRMTWO_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 3:
      aSample.setTable(DRMTHREE_DATA); // change the current wavetable
      CURRENT_TABLE = DRMTHREE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 4:
      aSample.setTable(DRMFOUR_DATA); // change the current wavetable
      CURRENT_TABLE = DRMFOUR_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 5:
      aSample.setTable(DRMFIVE_DATA); // change the current wavetable
      CURRENT_TABLE = DRMFIVE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 6:
      aSample.setTable(DRMSIX_DATA); // change the current wavetable
      CURRENT_TABLE = DRMSIX_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 7:
      aSample.setTable(DRMSEVEN_DATA); // change the current wavetable
      CURRENT_TABLE = DRMSEVEN_NUM_CELLS; // set the wavetable length to current wavetable
      break;
      
    case 8:
      aSample.setTable(DRMEIGHT_DATA); // change the current wavetable
      CURRENT_TABLE = DRMEIGHT_NUM_CELLS; // set the wavetable length to current wavetable
      break;
      
    case 9:
      aSample.setTable(DRMNINE_DATA); // change the current wavetable
      CURRENT_TABLE = DRMNINE_NUM_CELLS; // set the wavetable length to current wavetable
      break;
      
    case 10:
      aSample.setTable(DRMTEN_DATA); // change the current wavetable
      CURRENT_TABLE = DRMTEN_NUM_CELLS; // set the wavetable length to current wavetable
      break;
  }
