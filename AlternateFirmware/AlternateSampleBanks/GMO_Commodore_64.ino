...
#include <samples/wavetables/commodoreOne_int8.h> // Table for Sample
#include <samples/wavetables/commodoreTwo_int8.h> // Table for Sample 
#include <samples/wavetables/commodoreThree_int8.h> // Table for Sample 
#include <samples/wavetables/commodoreFour_int8.h> // Table for Sample 
#include <samples/wavetables/commodoreFive_int8.h> // Table for Sample 
#include <samples/wavetables/commodoreSix_int8.h> // Table for Sample


#define CONTROL_RATE 256 // powers of 2 please 

Sample <COMMODOREONE_NUM_CELLS, AUDIO_RATE> aSample(COMMODOREONE_DATA); // create the wavetable template 
...
*/
  ...
  */
  ...
  sampleSelect = map(sampleMath, 1, 1023, 1, 7); 
  ...
  */
  ...
  switch (sampleSelect) {
    case 1:
      aSample.setTable(COMMODOREONE_DATA); // change the current wavetable
      CURRENT_TABLE = COMMODOREONE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 2:
      aSample.setTable(COMMODORETWO_DATA); // change the current wavetable
      CURRENT_TABLE = COMMODORETWO_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 3:
      aSample.setTable(COMMODORETHREE_DATA); // change the current wavetable
      CURRENT_TABLE = COMMODORETHREE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 4:
      aSample.setTable(COMMODOREFOUR_DATA); // change the current wavetable
      CURRENT_TABLE = COMMODOREFOUR_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 5:
      aSample.setTable(COMMODOREFIVE_DATA); // change the current wavetable
      CURRENT_TABLE = COMMODOREFIVE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 6:
      aSample.setTable(COMMODORESIX_DATA); // change the current wavetable
      CURRENT_TABLE = COMMODORESIX_NUM_CELLS; // set the wavetable length to current wavetable
      break;
  }
