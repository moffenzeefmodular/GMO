...
#include <samples/Wavetables/opiumOne_int8.h> // Table for Sample
#include <samples/Wavetables/opiumTwo_int8.h> // Table for Sample 
#include <samples/Wavetables/opiumThree_int8.h> // Table for Sample 
#include <samples/Wavetables/opiumFour_int8.h> // Table for Sample 
#include <samples/Wavetables/opiumFive_int8.h> // Table for Sample 
#include <samples/Wavetables/opiumSix_int8.h> // Table for Sample
#include <samples/Wavetables/opiumSeven_int8.h> // Table for Sample 
#include <samples/Wavetables/opiumEight_int8.h> // Table for Sample 
#include <samples/Wavetables/opiumNine_int8.h> // Table for Sample 
#include <samples/Wavetables/opiumTen_int8.h> // Table for Sample 
#include <samples/Wavetables/opiumEleven_int8.h> // Table for Sample 
#include <samples/Wavetables/opiumTwelve_int8.h> // Table for Sample 
#include <samples/Wavetables/opiumThirteen_int8.h> // Table for Sample 
#include <samples/Wavetables/opiumFourteen_int8.h> // Table for Sample 


#define CONTROL_RATE 256 // powers of 2 please 

Sample <OPIUMONE_NUM_CELLS, AUDIO_RATE> aSample(OPIUMONE_DATA); // create the wavetable template 
...
*/
  ...
  */
  ...
  pitch = mapfloat(pitchMath, 1, 1023, 1.0, 7.0); // map from 0.01% to triple speed
  ...
  */
  ...
  sampleSelect = map(sampleMath, 1, 1023, 1, 15); 
  ...
  */
  ...
  switch (sampleSelect) {
    case 1:
      aSample.setTable(OPIUMONE_DATA); // change the current wavetable
      CURRENT_TABLE = OPIUMONE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 2:
      aSample.setTable(OPIUMTWO_DATA); // change the current wavetable
      CURRENT_TABLE = OPIUMTWO_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 3:
      aSample.setTable(OPIUMTHREE_DATA); // change the current wavetable
      CURRENT_TABLE = OPIUMTHREE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 4:
      aSample.setTable(OPIUMFOUR_DATA); // change the current wavetable
      CURRENT_TABLE = OPIUMFOUR_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 5:
      aSample.setTable(OPIUMFIVE_DATA); // change the current wavetable
      CURRENT_TABLE = OPIUMFIVE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 6:
      aSample.setTable(OPIUMSIX_DATA); // change the current wavetable
      CURRENT_TABLE = OPIUMSIX_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 7:
      aSample.setTable(OPIUMSEVEN_DATA); // change the current wavetable
      CURRENT_TABLE = OPIUMSEVEN_NUM_CELLS; // set the wavetable length to current wavetable
      break;
      
    case 8:
      aSample.setTable(OPIUMEIGHT_DATA); // change the current wavetable
      CURRENT_TABLE = OPIUMEIGHT_NUM_CELLS; // set the wavetable length to current wavetable
      break;
      
    case 9:
      aSample.setTable(OPIUMNINE_DATA); // change the current wavetable
      CURRENT_TABLE = OPIUMNINE_NUM_CELLS; // set the wavetable length to current wavetable
      break;
      
    case 10:
      aSample.setTable(OPIUMTEN_DATA); // change the current wavetable
      CURRENT_TABLE = OPIUMTEN_NUM_CELLS; // set the wavetable length to current wavetable
      break;
      
    case 11:
      aSample.setTable(OPIUMELEVEN_DATA); // change the current wavetable
      CURRENT_TABLE = OPIUMELEVEN_NUM_CELLS; // set the wavetable length to current wavetable
      break;
      
    case 12:
      aSample.setTable(OPIUMTWELVE_DATA); // change the current wavetable
      CURRENT_TABLE = OPIUMTWELVE_NUM_CELLS; // set the wavetable length to current wavetable
      break;
      
    case 13:
      aSample.setTable(OPIUMTHIRTEEN_DATA); // change the current wavetable
      CURRENT_TABLE = OPIUMTHIRTEEN_NUM_CELLS; // set the wavetable length to current wavetable
      break;
      
    case 14:
      aSample.setTable(OPIUMFOURTEEN_DATA); // change the current wavetable
      CURRENT_TABLE = OPIUMFOURTEEN_NUM_CELLS; // set the wavetable length to current wavetable
      break;      
  }
