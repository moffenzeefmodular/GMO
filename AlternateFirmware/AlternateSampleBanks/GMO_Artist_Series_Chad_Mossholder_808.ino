...
#include <samples/Wavetables/eoe_1_int8.h> // Table for Sample
#include <samples/Wavetables/eoe_2_int8.h> // Table for Sample 
#include <samples/Wavetables/eoe_3_int8.h> // Table for Sample 
#include <samples/Wavetables/eoe_4_int8.h> // Table for Sample 
#include <samples/Wavetables/eoe_5_int8.h> // Table for Sample 
#include <samples/Wavetables/eoe_6_int8.h> // Table for Sample
#include <samples/Wavetables/eoe_7_int8.h> // Table for Sample 
#include <samples/Wavetables/eoe_8_int8.h> // Table for Sample

#define CONTROL_RATE 256 // powers of 2 please 

Sample <EOE_1_NUM_CELLS, AUDIO_RATE> aSample(EOE_1_DATA); // create the wavetable template 
...
*/
  ...
  */
  ...
  switch (sampleSelect) {
    case 1:
      aSample.setTable(EOE_1_DATA); // change the current wavetable
      CURRENT_TABLE = EOE_1_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 2:
      aSample.setTable(EOE_2_DATA); // change the current wavetable
      CURRENT_TABLE = EOE_2_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 3:
      aSample.setTable(EOE_3_DATA); // change the current wavetable
      CURRENT_TABLE = EOE_3_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 4:
      aSample.setTable(EOE_4_DATA); // change the current wavetable
      CURRENT_TABLE = EOE_4_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 5:
      aSample.setTable(EOE_5_DATA); // change the current wavetable
      CURRENT_TABLE = EOE_5_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 6:
      aSample.setTable(EOE_6_DATA); // change the current wavetable
      CURRENT_TABLE = EOE_6_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 7:
      aSample.setTable(EOE_7_DATA); // change the current wavetable
      CURRENT_TABLE = EOE_7_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 8:
      aSample.setTable(EOE_8_DATA); // change the current wavetable
      CURRENT_TABLE = EOE_8_NUM_CELLS; // set the wavetable length to current wavetable
      break;
  }
