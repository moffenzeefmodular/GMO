...
#include <samples/Wavetables/rlOne_int8.h> // Table for Sample
#include <samples/Wavetables/rlTwo_int8.h> // Table for Sample 
#include <samples/Wavetables/rlThree_int8.h> // Table for Sample 
#include <samples/Wavetables/rlFour_int8.h> // Table for Sample 
#include <samples/Wavetables/rlFive_int8.h> // Table for Sample 
#include <samples/Wavetables/rlSix_int8.h> // Table for Sample
#include <samples/Wavetables/rlSeven_int8.h> // Table for Sample 
#include <samples/Wavetables/rlEight_int8.h> // Table for Sample

#define CONTROL_RATE 256 // powers of 2 please 

Sample <RLONE_NUM_CELLS, AUDIO_RATE> aSample(RLONE_DATA); // create the wavetable template 
...
*/
  ...
  */
  ...
  switch (sampleSelect) {
    case 1:
      aSample.setTable(RLONE_DATA); // change the current wavetable
      CURRENT_TABLE = RLONE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 2:
      aSample.setTable(RLTWO_DATA); // change the current wavetable
      CURRENT_TABLE = RLTWO_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 3:
      aSample.setTable(RLTHREE_DATA); // change the current wavetable
      CURRENT_TABLE = RLTHREE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 4:
      aSample.setTable(RLFOUR_DATA); // change the current wavetable
      CURRENT_TABLE = RLFOUR_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 5:
      aSample.setTable(RLFIVE_DATA); // change the current wavetable
      CURRENT_TABLE = RLFIVE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 6:
      aSample.setTable(RLSIX_DATA); // change the current wavetable
      CURRENT_TABLE = RLSIX_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 7:
      aSample.setTable(RLSEVEN_DATA); // change the current wavetable
      CURRENT_TABLE = RLSEVEN_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 8:
      aSample.setTable(RLEIGHT_DATA); // change the current wavetable
      CURRENT_TABLE = RLEIGHT_NUM_CELLS; // set the wavetable length to current wavetable
      break;
  }
