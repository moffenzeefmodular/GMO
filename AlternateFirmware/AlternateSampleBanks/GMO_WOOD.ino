...
Sample <WOODONE_NUM_CELLS, AUDIO_RATE> aSample(WOODONE_DATA); // create the wavetable template 
...
*/
  ...
  */
  ...
  switch (sampleSelect) {
    case 1:
      aSample.setTable(WOODTHREE_DATA); // change the current wavetable
      CURRENT_TABLE = WOODTHREE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 2:
      aSample.setTable(WOODFOUR_DATA); // change the current wavetable
      CURRENT_TABLE = WOODFOUR_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 3:
      aSample.setTable(WOODONE_DATA); // change the current wavetable
      CURRENT_TABLE = WOODONE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 4:
      aSample.setTable(WOODSIX_DATA); // change the current wavetable
      CURRENT_TABLE = WOODSIX_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 5:
      aSample.setTable(WOODTWO_DATA); // change the current wavetable
      CURRENT_TABLE = WOODTWO_NUM_CELLS; // set the wavetable length to current wavetable
      break;
      
    case 6:
      aSample.setTable(WOODFIVE_DATA); // change the current wavetable
      CURRENT_TABLE = WOODFIVE_NUM_CELLS; // set the wavetable length to current wavetable
      break;
      
    case 7:
      aSample.setTable(BLOCKFIVE_DATA); // change the current wavetable
      CURRENT_TABLE = BLOCKFIVE_NUM_CELLS; // set the wavetable length to current wavetable
      break;
      
    case 8:
      aSample.setTable(WOODEIGHT_DATA); // change the current wavetable
      CURRENT_TABLE = WOODEIGHT_NUM_CELLS; // set the wavetable length to current wavetable
      break;
