...
Sample <TABLAONE_NUM_CELLS, AUDIO_RATE> aSample(TABLAONE_DATA); // create the wavetable template 
...
*/
  ...
  */
  ...
  pitch = mapfloat(pitchMath, 1, 1023, 0.01, 5.0); // map from 0.01% to triple speed
  ...
  */
  ...
  /* 
  map from 1 to 10 (the number of sound files loaded + 1 to account for 0). If adding more files into the sketch, 
  ...
  */
  ...
  switch (sampleSelect) {
    case 1:
      aSample.setTable(TABLAONE_DATA); // change the current wavetable
      CURRENT_TABLE = TABLAONE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 2:
      aSample.setTable(TABLATWO_DATA); // change the current wavetable
      CURRENT_TABLE = TABLATWO_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 3:
      aSample.setTable(TABLATHREE_DATA); // change the current wavetable
      CURRENT_TABLE = TABLATHREE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 4:
      aSample.setTable(TABLAFOUR_DATA); // change the current wavetable
      CURRENT_TABLE = TABLAFOUR_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 5:
      aSample.setTable(TABLAFIVE_DATA); // change the current wavetable
      CURRENT_TABLE = TABLAFIVE_NUM_CELLS; // set the wavetable length to current wavetable
      break;
      
    case 6:
      aSample.setTable(TABLASIX_DATA); // change the current wavetable
      CURRENT_TABLE = TABLASIX_NUM_CELLS; // set the wavetable length to current wavetable
      break;
      
    case 7:
      aSample.setTable(TABLASEVEN_DATA); // change the current wavetable
      CURRENT_TABLE = TABLASEVEN_NUM_CELLS; // set the wavetable length to current wavetable
      break;
      
    case 8:
      aSample.setTable(TABLAEIGHT_DATA); // change the current wavetable
      CURRENT_TABLE = TABLAEIGHT_NUM_CELLS; // set the wavetable length to current wavetable
      break;
     
    case 9:
      aSample.setTable(TABLANINE_DATA); // change the current wavetable
      CURRENT_TABLE = TABLANINE_NUM_CELLS; // set the wavetable length to current wavetable
      break;
