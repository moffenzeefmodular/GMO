...
#include <samples/wavetables/sseventyeightOne_int8.h> // Table for Sample
#include <samples/wavetables/sseventyeightTwo_int8.h> // Table for Sample 
#include <samples/wavetables/sseventyeightThree_int8.h> // Table for Sample 
#include <samples/wavetables/sseventyeightFour_int8.h> // Table for Sample 
#include <samples/wavetables/sseventyeightFive_int8.h> // Table for Sample
#include <samples/wavetables/sseventyeightSix_int8.h> // Table for Sample 
#include <samples/wavetables/sseventyeightSeven_int8.h> // Table for Sample 
#include <samples/wavetables/sseventyeightEight_int8.h> // Table for Sample 
#include <samples/wavetables/sseventyeightNine_int8.h> // Table for Sample 
#include <samples/wavetables/sseventyeightTen_int8.h> // Table for Sample 
#include <samples/wavetables/sseventyeightEleven_int8.h> // Table for Sample 


#define CONTROL_RATE 256 // powers of 2 please 

Sample <SSEVENTYEIGHTONE_NUM_CELLS, AUDIO_RATE> aSample(SSEVENTYEIGHTONE_DATA); // create the wavetable template 
...
*/
  ...
  */
  ...
  pitch = mapfloat(pitchMath, 1, 1023, 1.0, 5.0); // map from 0.01% to triple speed
  ...
  */
  ...
  sampleSelect = map(sampleMath, 1, 1023, 1, 12); 
  ...
  */
  ...
  switch (sampleSelect) {
    ...
    case 1:
      aSample.setTable(SSEVENTYEIGHTONE_DATA); // change the current wavetable
      CURRENT_TABLE = SSEVENTYEIGHTONE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 2:
      aSample.setTable(SSEVENTYEIGHTTWO_DATA); // change the current wavetable
      CURRENT_TABLE = SSEVENTYEIGHTTWO_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 3:
      aSample.setTable(SSEVENTYEIGHTTHREE_DATA); // change the current wavetable
      CURRENT_TABLE = SSEVENTYEIGHTTHREE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 4:
      aSample.setTable(SSEVENTYEIGHTFOUR_DATA); // change the current wavetable
      CURRENT_TABLE = SSEVENTYEIGHTFOUR_NUM_CELLS; // set the wavetable length to current wavetable
      break;
      
    case 5:
      aSample.setTable(SSEVENTYEIGHTFIVE_DATA); // change the current wavetable
      CURRENT_TABLE = SSEVENTYEIGHTFIVE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 6:
      aSample.setTable(SSEVENTYEIGHTSIX_DATA); // change the current wavetable
      CURRENT_TABLE = SSEVENTYEIGHTSIX_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 7:
      aSample.setTable(SSEVENTYEIGHTSEVEN_DATA); // change the current wavetable
      CURRENT_TABLE = SSEVENTYEIGHTSEVEN_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 8:
      aSample.setTable(SSEVENTYEIGHTEIGHT_DATA); // change the current wavetable
      CURRENT_TABLE = SSEVENTYEIGHTEIGHT_NUM_CELLS; // set the wavetable length to current wavetable
      break;  

    case 9:
      aSample.setTable(SSEVENTYEIGHTNINE_DATA); // change the current wavetable
      CURRENT_TABLE = SSEVENTYEIGHTNINE_NUM_CELLS; // set the wavetable length to current wavetable
      break;   
      
    case 10:
      aSample.setTable(SSEVENTYEIGHTTEN_DATA); // change the current wavetable
      CURRENT_TABLE = SSEVENTYEIGHTTEN_NUM_CELLS; // set the wavetable length to current wavetable
      break;
      
    case 11:
      aSample.setTable(SSEVENTYEIGHTELEVEN_DATA); // change the current wavetable
      CURRENT_TABLE = SSEVENTYEIGHTELEVEN_NUM_CELLS; // set the wavetable length to current wavetable
      break;     
