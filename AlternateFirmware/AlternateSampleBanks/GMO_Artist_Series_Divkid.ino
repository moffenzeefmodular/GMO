...
#include <samples/Wavetables/divkidOne_int8.h> // Table for Sample
#include <samples/Wavetables/divkidTwo_int8.h> // Table for Sample 
#include <samples/Wavetables/divkidThree_int8.h> // Table for Sample 
#include <samples/Wavetables/divkidFour_int8.h> // Table for Sample 
#include <samples/Wavetables/divkidFive_int8.h> // Table for Sample 
#include <samples/Wavetables/divkidSix_int8.h> // Table for Sample
#include <samples/Wavetables/divkidSeven_int8.h> // Table for Sample 
#include <samples/Wavetables/divkidEight_int8.h> // Table for Sample

#define CONTROL_RATE 256 // powers of 2 please 

Sample <DIVKIDONE_NUM_CELLS, AUDIO_RATE> aSample(DIVKIDONE_DATA); // create the wavetable template 
...
*/
  ...
  */
  ...
  pitch = mapfloat(pitchMath, 1, 1023, 0.01, 7.0); // map from 0.01% to triple speed
  ...
  */
  ...
  switch (sampleSelect) {
    case 1:
      aSample.setTable(DIVKIDONE_DATA); // change the current wavetable
      CURRENT_TABLE = DIVKIDONE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 2:
      aSample.setTable(DIVKIDTWO_DATA); // change the current wavetable
      CURRENT_TABLE = DIVKIDTWO_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 3:
      aSample.setTable(DIVKIDTHREE_DATA); // change the current wavetable
      CURRENT_TABLE = DIVKIDTHREE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 4:
      aSample.setTable(DIVKIDFOUR_DATA); // change the current wavetable
      CURRENT_TABLE = DIVKIDFOUR_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 5:
      aSample.setTable(DIVKIDFIVE_DATA); // change the current wavetable
      CURRENT_TABLE = DIVKIDFIVE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 6:
      aSample.setTable(DIVKIDSIX_DATA); // change the current wavetable
      CURRENT_TABLE = DIVKIDSIX_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 7:
      aSample.setTable(DIVKIDSEVEN_DATA); // change the current wavetable
      CURRENT_TABLE = DIVKIDSEVEN_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 8:
      aSample.setTable(DIVKIDEIGHT_DATA); // change the current wavetable
      CURRENT_TABLE = DIVKIDEIGHT_NUM_CELLS; // set the wavetable length to current wavetable
      break;
  }
