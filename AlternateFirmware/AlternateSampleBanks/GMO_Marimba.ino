...
#include <samples/wavetables/marimbaOne_int8.h> // Table for Sample
#include <samples/wavetables/marimbaTwo_int8.h> // Table for Sample 
#include <samples/wavetables/marimbaThree_int8.h> // Table for Sample 
#include <samples/wavetables/marimbaFour_int8.h> // Table for Sample 
#include <samples/wavetables/marimbaFive_int8.h> // Table for Sample 
#include <samples/wavetables/marimbaSix_int8.h> // Table for Sample
#include <samples/wavetables/marimbaSeven_int8.h> // Table for Sample 
#include <samples/wavetables/marimbaEight_int8.h> // Table for Sample

#define CONTROL_RATE 256 // powers of 2 please 

Sample <MARIMBAONE_NUM_CELLS, AUDIO_RATE> aSample(MARIMBAONE_DATA); // create the wavetable template 
...
*/
  ...
  */
  ...
  switch (sampleSelect) {
    case 1:
      aSample.setTable(MARIMBAONE_DATA); // change the current wavetable
      CURRENT_TABLE = MARIMBAONE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 2:
      aSample.setTable(MARIMBATWO_DATA); // change the current wavetable
      CURRENT_TABLE = MARIMBATWO_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 3:
      aSample.setTable(MARIMBATHREE_DATA); // change the current wavetable
      CURRENT_TABLE = MARIMBATHREE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 4:
      aSample.setTable(MARIMBAFOUR_DATA); // change the current wavetable
      CURRENT_TABLE = MARIMBAFOUR_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 5:
      aSample.setTable(MARIMBAFIVE_DATA); // change the current wavetable
      CURRENT_TABLE = MARIMBAFIVE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 6:
      aSample.setTable(MARIMBASIX_DATA); // change the current wavetable
      CURRENT_TABLE = MARIMBASIX_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 7:
      aSample.setTable(MARIMBASEVEN_DATA); // change the current wavetable
      CURRENT_TABLE = MARIMBASEVEN_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 8:
      aSample.setTable(MARIMBAEIGHT_DATA); // change the current wavetable
      CURRENT_TABLE = MARIMBAEIGHT_NUM_CELLS; // set the wavetable length to current wavetable
      break;
