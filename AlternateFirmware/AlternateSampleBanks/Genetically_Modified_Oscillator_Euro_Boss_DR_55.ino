...
#include <samples/wavetables/drfiftyfiveOne_int8.h> // Table for Sample
#include <samples/wavetables/drfiftyfiveTwo_int8.h> // Table for Sample 
#include <samples/wavetables/drfiftyfiveThree_int8.h> // Table for Sample 
#include <samples/wavetables/drfiftyfiveFour_int8.h> // Table for Sample 


#define CONTROL_RATE 256 // powers of 2 please 

Sample <DRFIFTYFIVEONE_NUM_CELLS, AUDIO_RATE> aSample(DRFIFTYFIVEONE_DATA); // create the wavetable template 
...
*/
  ...
  */
  ...
  sampleSelect = map(sampleMath, 1, 1023, 1, 5); 
  ...
  */
  ...
  switch (sampleSelect) {
    case 1:
      aSample.setTable(DRFIFTYFIVEONE_DATA); // change the current wavetable
      CURRENT_TABLE = DRFIFTYFIVEONE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 2:
      aSample.setTable(DRFIFTYFIVETWO_DATA); // change the current wavetable
      CURRENT_TABLE = DRFIFTYFIVETWO_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 3:
      aSample.setTable(DRFIFTYFIVETHREE_DATA); // change the current wavetable
      CURRENT_TABLE = DRFIFTYFIVETHREE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 4:
      aSample.setTable(DRFIFTYFIVEFOUR_DATA); // change the current wavetable
      CURRENT_TABLE = DRFIFTYFIVEFOUR_NUM_CELLS; // set the wavetable length to current wavetable
      break;
