...
#include <samples/Wavetables/clockOne_int8.h> // Table for Sample
#include <samples/Wavetables/clockTwo_int8.h> // Table for Sample 
#include <samples/Wavetables/clockThree_int8.h> // Table for Sample 
#include <samples/Wavetables/clockFour_int8.h> // Table for Sample 
#include <samples/Wavetables/clockFive_int8.h> // Table for Sample 
#include <samples/Wavetables/clockSix_int8.h> // Table for Sample 
#include <samples/Wavetables/clockSeven_int8.h> // Table for Sample 
#include <samples/Wavetables/clockEight_int8.h> // Table for Sample 
#include <samples/Wavetables/clockNine_int8.h> // Table for Sample 

#define CONTROL_RATE 256 // powers of 2 please 

Sample <CLOCKONE_NUM_CELLS, AUDIO_RATE> aSample(CLOCKONE_DATA); // create the wavetable template 
...
*/
  ...
  */
  ...
  switch (sampleSelect) {
    case 1:
      aSample.setTable(CLOCKONE_DATA); // change the current wavetable
      CURRENT_TABLE = CLOCKONE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 2:
      aSample.setTable(CLOCKTWO_DATA); // change the current wavetable
      CURRENT_TABLE = CLOCKTWO_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 3:
      aSample.setTable(CLOCKTHREE_DATA); // change the current wavetable
      CURRENT_TABLE = CLOCKTHREE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 4:
      aSample.setTable(CLOCKFOUR_DATA); // change the current wavetable
      CURRENT_TABLE = CLOCKFOUR_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 5:
      aSample.setTable(CLOCKFIVE_DATA); // change the current wavetable
      CURRENT_TABLE = CLOCKFIVE_NUM_CELLS; // set the wavetable length to current wavetable
      break;
      
    case 6:
      aSample.setTable(CLOCKSIX_DATA); // change the current wavetable
      CURRENT_TABLE = CLOCKSIX_NUM_CELLS; // set the wavetable length to current wavetable
      break;
      
    case 7:
      aSample.setTable(CLOCKSEVEN_DATA); // change the current wavetable
      CURRENT_TABLE = CLOCKSEVEN_NUM_CELLS; // set the wavetable length to current wavetable
      break;
      
    case 8:
      aSample.setTable(CLOCKEIGHT_DATA); // change the current wavetable
      CURRENT_TABLE = CLOCKEIGHT_NUM_CELLS; // set the wavetable length to current wavetable
      break;
            
    case 9:
      aSample.setTable(CLOCKNINE_DATA); // change the current wavetable
      CURRENT_TABLE = CLOCKNINE_NUM_CELLS; // set the wavetable length to current wavetable
      break;
