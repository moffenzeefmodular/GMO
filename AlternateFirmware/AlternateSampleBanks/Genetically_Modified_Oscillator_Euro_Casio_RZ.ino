...
#include <samples/wavetables/rzOne_int8.h> // Table for Sample
#include <samples/wavetables/rzTwo_int8.h> // Table for Sample 
#include <samples/wavetables/rzThree_int8.h> // Table for Sample 
#include <samples/wavetables/rzFour_int8.h> // Table for Sample 
#include <samples/wavetables/rzFive_int8.h> // Table for Sample 
#include <samples/wavetables/rzSix_int8.h> // Table for Sample
#include <samples/wavetables/rzSeven_int8.h> // Table for Sample 
#include <samples/wavetables/rzEight_int8.h> // Table for Sample
#include <samples/wavetables/rzNine_int8.h> // Table for Sample
#include <samples/wavetables/rzTen_int8.h> // Table for Sample
#include <samples/wavetables/rzEleven_int8.h> // Table for Sample
#include <samples/wavetables/rzTwelve_int8.h> // Table for Sample


#define CONTROL_RATE 256 // powers of 2 please 

Sample <RZONE_NUM_CELLS, AUDIO_RATE> aSample(RZONE_DATA); // create the wavetable template 
...
*/
  ...
  */
  ...
  switch (sampleSelect) {
    case 1:
      aSample.setTable(RZONE_DATA); // change the current wavetable
      CURRENT_TABLE = RZONE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 2:
      aSample.setTable(RZTWO_DATA); // change the current wavetable
      CURRENT_TABLE = RZTWO_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 3:
      aSample.setTable(RZTHREE_DATA); // change the current wavetable
      CURRENT_TABLE = RZTHREE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 4:
      aSample.setTable(RZFOUR_DATA); // change the current wavetable
      CURRENT_TABLE = RZFOUR_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 5:
      aSample.setTable(RZFIVE_DATA); // change the current wavetable
      CURRENT_TABLE = RZFIVE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 6:
      aSample.setTable(RZSIX_DATA); // change the current wavetable
      CURRENT_TABLE = RZSIX_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 7:
      aSample.setTable(RZSEVEN_DATA); // change the current wavetable
      CURRENT_TABLE = RZSEVEN_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 8:
      aSample.setTable(RZEIGHT_DATA); // change the current wavetable
      CURRENT_TABLE = RZEIGHT_NUM_CELLS; // set the wavetable length to current wavetable
      break;
      
    case 9:
      aSample.setTable(RZNINE_DATA); // change the current wavetable
      CURRENT_TABLE = RZNINE_NUM_CELLS; // set the wavetable length to current wavetable
      break;
      
    case 10:
      aSample.setTable(RZTEN_DATA); // change the current wavetable
      CURRENT_TABLE = RZTEN_NUM_CELLS; // set the wavetable length to current wavetable
      break;
      
    case 11:
      aSample.setTable(RZELEVEN_DATA); // change the current wavetable
      CURRENT_TABLE = RZELEVEN_NUM_CELLS; // set the wavetable length to current wavetable
      break;
            
    case 12:
      aSample.setTable(RZTWELVE_DATA); // change the current wavetable
      CURRENT_TABLE = RZTWELVE_NUM_CELLS; // set the wavetable length to current wavetable
      break;
  }
