...
Sample <MARIOONE_NUM_CELLS, AUDIO_RATE> aSample(MARIOONE_DATA); // create the wavetable template 
...
*/
  ...
  */
  ...
  switch (sampleSelect) {
    case 1:
      aSample.setTable(MARIOONE_DATA); // change the current wavetable
      CURRENT_TABLE = MARIOONE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 2:
      aSample.setTable(MARIOTWO_DATA); // change the current wavetable
      CURRENT_TABLE = MARIOTWO_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 3:
      aSample.setTable(MARIOTHREE_DATA); // change the current wavetable
      CURRENT_TABLE = MARIOTHREE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 4:
      aSample.setTable(MARIOFOUR_DATA); // change the current wavetable
      CURRENT_TABLE = MARIOFOUR_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 5:
      aSample.setTable(MARIOFIVE_DATA); // change the current wavetable
      CURRENT_TABLE = MARIOFIVE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 6:
      aSample.setTable(MARIOSIX_DATA); // change the current wavetable
      CURRENT_TABLE = MARIOSIX_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 7:
      aSample.setTable(MARIOSEVEN_DATA); // change the current wavetable
      CURRENT_TABLE = MARIOSEVEN_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 8:
      aSample.setTable(MARIOEIGHT_DATA); // change the current wavetable
      CURRENT_TABLE = MARIOEIGHT_NUM_CELLS; // set the wavetable length to current wavetable
      break;
  }
