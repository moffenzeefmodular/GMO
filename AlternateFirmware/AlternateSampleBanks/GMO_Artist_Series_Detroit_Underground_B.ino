...
#include <samples/wavetables/duFourteen_int8.h> // Table for Sample
#include <samples/wavetables/duFifteen_int8.h> // Table for Sample 
#include <samples/wavetables/duSixteen_int8.h> // Table for Sample 
#include <samples/wavetables/duSeventeen_int8.h> // Table for Sample 
#include <samples/wavetables/duEighteen_int8.h> // Table for Sample
#include <samples/wavetables/duNineteen_int8.h> // Table for Sample 
#include <samples/wavetables/duTwenty_int8.h> // Table for Sample 
#include <samples/wavetables/duTwentyOne_int8.h> // Table for Sample 
#include <samples/wavetables/duTwentyTwo_int8.h> // Table for Sample 
#include <samples/wavetables/duTwentyThree_int8.h> // Table for Sample 
#include <samples/wavetables/duTwentyFour_int8.h> // Table for Sample 



#define CONTROL_RATE 256 // powers of 2 please 

Sample <DUFOURTEEN_NUM_CELLS, AUDIO_RATE> aSample(DUFOURTEEN_DATA); // create the wavetable template 
...
*/
  ...
  */
  ...
  switch (sampleSelect) {
    case 1:
      aSample.setTable(DUFOURTEEN_DATA); // change the current wavetable
      CURRENT_TABLE = DUFOURTEEN_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 2:
      aSample.setTable(DUFIFTEEN_DATA); // change the current wavetable
      CURRENT_TABLE = DUFIFTEEN_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 3:
      aSample.setTable(DUSIXTEEN_DATA); // change the current wavetable
      CURRENT_TABLE = DUSIXTEEN_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 4:
      aSample.setTable(DUSEVENTEEN_DATA); // change the current wavetable
      CURRENT_TABLE = DUSEVENTEEN_NUM_CELLS; // set the wavetable length to current wavetable
      break;
      
    case 5:
      aSample.setTable(DUEIGHTEEN_DATA); // change the current wavetable
      CURRENT_TABLE = DUEIGHTEEN_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 6:
      aSample.setTable(DUNINETEEN_DATA); // change the current wavetable
      CURRENT_TABLE = DUNINETEEN_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 7:
      aSample.setTable(DUTWENTY_DATA); // change the current wavetable
      CURRENT_TABLE = DUTWENTY_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 8:
      aSample.setTable(DUTWENTYONE_DATA); // change the current wavetable
      CURRENT_TABLE = DUTWENTYONE_NUM_CELLS; // set the wavetable length to current wavetable
      break;  

    case 9:
      aSample.setTable(DUTWENTYTWO_DATA); // change the current wavetable
      CURRENT_TABLE = DUTWENTYTWO_NUM_CELLS; // set the wavetable length to current wavetable
      break;   
      
    case 10:
      aSample.setTable(DUTWENTYTHREE_DATA); // change the current wavetable
      CURRENT_TABLE = DUTWENTYTHREE_NUM_CELLS; // set the wavetable length to current wavetable
      break;  
      
    case 11:
      aSample.setTable(DUTWENTYFOUR_DATA); // change the current wavetable
      CURRENT_TABLE = DUTWENTYFOUR_NUM_CELLS; // set the wavetable length to current wavetable
      break;   
