...
#include <samples/Wavetables/mb_1_int8.h> // Table for Sample
#include <samples/Wavetables/mb_2_int8.h> // Table for Sample 
#include <samples/Wavetables/mb_3_int8.h> // Table for Sample 
#include <samples/Wavetables/mb_4_int8.h> // Table for Sample 
#include <samples/Wavetables/mb_5_int8.h> // Table for Sample 
#include <samples/Wavetables/mb_6_int8.h> // Table for Sample
#include <samples/Wavetables/mb_7_int8.h> // Table for Sample 
#include <samples/Wavetables/mb_8_int8.h> // Table for Sample

#define CONTROL_RATE 256 // powers of 2 please 

Sample <MB_1_NUM_CELLS, AUDIO_RATE> aSample(MB_1_DATA); // create the wavetable template 
...
*/
  ...
  */
  ...
  switch (sampleSelect) {
    case 1:
      aSample.setTable(MB_1_DATA); // change the current wavetable
      CURRENT_TABLE = MB_1_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 2:
      aSample.setTable(MB_2_DATA); // change the current wavetable
      CURRENT_TABLE = MB_2_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 3:
      aSample.setTable(MB_3_DATA); // change the current wavetable
      CURRENT_TABLE = MB_3_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 4:
      aSample.setTable(MB_4_DATA); // change the current wavetable
      CURRENT_TABLE = MB_4_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 5:
      aSample.setTable(MB_5_DATA); // change the current wavetable
      CURRENT_TABLE = MB_5_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 6:
      aSample.setTable(MB_6_DATA); // change the current wavetable
      CURRENT_TABLE = MB_6_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 7:
      aSample.setTable(MB_7_DATA); // change the current wavetable
      CURRENT_TABLE = MB_7_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 8:
      aSample.setTable(MB_8_DATA); // change the current wavetable
      CURRENT_TABLE = MB_8_NUM_CELLS; // set the wavetable length to current wavetable
      break;
  }
  ...
  analogWrite(A9, (int)aSample.next() * 50); // mirror the audio output boost the gain x 100  and write it to the LED 
