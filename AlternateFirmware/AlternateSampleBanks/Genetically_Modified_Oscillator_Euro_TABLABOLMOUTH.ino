...
Sample <DA_NUM_CELLS, AUDIO_RATE> aSample(DA_DATA); // create the wavetable template 
...
*/
  ...
  */
  ...
  pitch = mapfloat(pitchMath, 1, 1023, 0.01, 6.0); // map from 0.01% to triple speed
  ...
  */
  ...
  /* 
  map from 1 to 8 (the number of sound files loaded + 1 to account for 0). If adding more files into the sketch, 
  ...
  */
  ...
  switch (sampleSelect) {
    case 1:
      aSample.setTable(DA_DATA); // change the current wavetable
      CURRENT_TABLE = DA_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 2:
      aSample.setTable(DH_DATA); // change the current wavetable
      CURRENT_TABLE = DH_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 3:
      aSample.setTable(GA_DATA); // change the current wavetable
      CURRENT_TABLE = GA_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 4:
      aSample.setTable(K_DATA); // change the current wavetable
      CURRENT_TABLE = K_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 5:
      aSample.setTable(RA_DATA); // change the current wavetable
      CURRENT_TABLE = RA_NUM_CELLS; // set the wavetable length to current wavetable
      break;
      
    case 6:
      aSample.setTable(T_DATA); // change the current wavetable
      CURRENT_TABLE = T_NUM_CELLS; // set the wavetable length to current wavetable
      break;
      
    case 7:
      aSample.setTable(TA_DATA); // change the current wavetable
      CURRENT_TABLE = TA_NUM_CELLS; // set the wavetable length to current wavetable
      break;
