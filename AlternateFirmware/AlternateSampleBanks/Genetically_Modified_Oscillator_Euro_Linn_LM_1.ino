...
#include <samples/wavetables/linnOne_int8.h> // Table for Sample
#include <samples/wavetables/linnTwo_int8.h> // Table for Sample 
#include <samples/wavetables/linnThree_int8.h> // Table for Sample 
#include <samples/wavetables/linnFour_int8.h> // Table for Sample 
#include <samples/wavetables/linnFive_int8.h> // Table for Sample
#include <samples/wavetables/linnSix_int8.h> // Table for Sample 
#include <samples/wavetables/linnSeven_int8.h> // Table for Sample 
#include <samples/wavetables/linnEight_int8.h> // Table for Sample 
#include <samples/wavetables/linnNine_int8.h> // Table for Sample 
#include <samples/wavetables/linnTen_int8.h> // Table for Sample 
#include <samples/wavetables/linnEleven_int8.h> // Table for Sample 
#include <samples/wavetables/linnTwelve_int8.h> // Table for Sample 
#include <samples/wavetables/linnThirteen_int8.h> // Table for Sample 
#include <samples/wavetables/linnFourteen_int8.h> // Table for Sample 
#include <samples/wavetables/linnFifteen_int8.h> // Table for Sample 


#define CONTROL_RATE 256 // powers of 2 please 

Sample <LINNONE_NUM_CELLS, AUDIO_RATE> aSample(LINNONE_DATA); // create the wavetable template 
...
*/
  ...
  */
  ...
  switch (sampleSelect) {
    case 1:
      aSample.setTable(LINNONE_DATA); // change the current wavetable
      CURRENT_TABLE = LINNONE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 2:
      aSample.setTable(LINNTWO_DATA); // change the current wavetable
      CURRENT_TABLE = LINNTWO_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 3:
      aSample.setTable(LINNTHREE_DATA); // change the current wavetable
      CURRENT_TABLE = LINNTHREE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 4:
      aSample.setTable(LINNFOUR_DATA); // change the current wavetable
      CURRENT_TABLE = LINNFOUR_NUM_CELLS; // set the wavetable length to current wavetable
      break;
      
    case 5:
      aSample.setTable(LINNFIVE_DATA); // change the current wavetable
      CURRENT_TABLE = LINNFIVE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 6:
      aSample.setTable(LINNSIX_DATA); // change the current wavetable
      CURRENT_TABLE = LINNSIX_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 7:
      aSample.setTable(LINNSEVEN_DATA); // change the current wavetable
      CURRENT_TABLE = LINNSEVEN_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 8:
      aSample.setTable(LINNEIGHT_DATA); // change the current wavetable
      CURRENT_TABLE = LINNEIGHT_NUM_CELLS; // set the wavetable length to current wavetable
      break;  

    case 9:
      aSample.setTable(LINNNINE_DATA); // change the current wavetable
      CURRENT_TABLE = LINNNINE_NUM_CELLS; // set the wavetable length to current wavetable
      break;   
      
    case 10:
      aSample.setTable(LINNTEN_DATA); // change the current wavetable
      CURRENT_TABLE = LINNTEN_NUM_CELLS; // set the wavetable length to current wavetable
      break;  
      
    case 11:
      aSample.setTable(LINNELEVEN_DATA); // change the current wavetable
      CURRENT_TABLE = LINNELEVEN_NUM_CELLS; // set the wavetable length to current wavetable
      break;   
      
    case 12:
      aSample.setTable(LINNTWELVE_DATA); // change the current wavetable
      CURRENT_TABLE = LINNTWELVE_NUM_CELLS; // set the wavetable length to current wavetable
      break;   
      
    case 13:
      aSample.setTable(LINNTHIRTEEN_DATA); // change the current wavetable
      CURRENT_TABLE = LINNTHIRTEEN_NUM_CELLS; // set the wavetable length to current wavetable
      break;    
      
    case 14:
      aSample.setTable(LINNFOURTEEN_DATA); // change the current wavetable
      CURRENT_TABLE = LINNFOURTEEN_NUM_CELLS; // set the wavetable length to current wavetable
      break;  
      
    case 15:
      aSample.setTable(LINNFIFTEEN_DATA); // change the current wavetable
      CURRENT_TABLE = LINNFIFTEEN_NUM_CELLS; // set the wavetable length to current wavetable
      break;    
