...
#include <samples/wavetables/eatStaticOne_int8.h> // Table for Sample
#include <samples/wavetables/eatStaticTwo_int8.h> // Table for Sample 
#include <samples/wavetables/eatStaticThree_int8.h> // Table for Sample 
#include <samples/wavetables/eatStaticFour_int8.h> // Table for Sample 
#include <samples/wavetables/eatStaticFive_int8.h> // Table for Sample
#include <samples/wavetables/eatStaticSix_int8.h> // Table for Sample 
#include <samples/wavetables/eatStaticSeven_int8.h> // Table for Sample 
#include <samples/wavetables/eatStaticEight_int8.h> // Table for Sample 
#include <samples/wavetables/eatStaticNine_int8.h> // Table for Sample 
#include <samples/wavetables/eatStaticTen_int8.h> // Table for Sample 
#include <samples/wavetables/eatStaticEleven_int8.h> // Table for Sample 
#include <samples/wavetables/eatStaticTwelve_int8.h> // Table for Sample 
#include <samples/wavetables/eatStaticThirteen_int8.h> // Table for Sample 
#include <samples/wavetables/eatStaticFourteen_int8.h> // Table for Sample 
#include <samples/wavetables/eatStaticFifteen_int8.h> // Table for Sample 


#define CONTROL_RATE 256 // powers of 2 please 

Sample <EATSTATICONE_NUM_CELLS, AUDIO_RATE> aSample(EATSTATICONE_DATA); // create the wavetable template 
...
*/
  ...
  */
  ...
  pitch = mapfloat(pitchMath, 1, 1023, 0.5, 7.0); // map from 0.01% to triple speed
  ...
  */
  ...
  sampleSelect = map(sampleMath, 1, 1023, 1, 16); 
  ...
  */
  ...
  switch (sampleSelect) {
    case 1:
      aSample.setTable(EATSTATICONE_DATA); // change the current wavetable
      CURRENT_TABLE = EATSTATICONE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 2:
      aSample.setTable(EATSTATICTWO_DATA); // change the current wavetable
      CURRENT_TABLE = EATSTATICTWO_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 3:
      aSample.setTable(EATSTATICTHREE_DATA); // change the current wavetable
      CURRENT_TABLE = EATSTATICTHREE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 4:
      aSample.setTable(EATSTATICFOUR_DATA); // change the current wavetable
      CURRENT_TABLE = EATSTATICFOUR_NUM_CELLS; // set the wavetable length to current wavetable
      break;
      
    case 5:
      aSample.setTable(EATSTATICFIVE_DATA); // change the current wavetable
      CURRENT_TABLE = EATSTATICFIVE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 6:
      aSample.setTable(EATSTATICSIX_DATA); // change the current wavetable
      CURRENT_TABLE = EATSTATICSIX_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 7:
      aSample.setTable(EATSTATICSEVEN_DATA); // change the current wavetable
      CURRENT_TABLE = EATSTATICSEVEN_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 8:
      aSample.setTable(EATSTATICEIGHT_DATA); // change the current wavetable
      CURRENT_TABLE = EATSTATICEIGHT_NUM_CELLS; // set the wavetable length to current wavetable
      break;  

    case 9:
      aSample.setTable(EATSTATICNINE_DATA); // change the current wavetable
      CURRENT_TABLE = EATSTATICNINE_NUM_CELLS; // set the wavetable length to current wavetable
      break;   
      
    case 10:
      aSample.setTable(EATSTATICTEN_DATA); // change the current wavetable
      CURRENT_TABLE = EATSTATICTEN_NUM_CELLS; // set the wavetable length to current wavetable
      break;  
      
    case 11:
      aSample.setTable(EATSTATICELEVEN_DATA); // change the current wavetable
      CURRENT_TABLE = EATSTATICELEVEN_NUM_CELLS; // set the wavetable length to current wavetable
      break;   
      
    case 12:
      aSample.setTable(EATSTATICTWELVE_DATA); // change the current wavetable
      CURRENT_TABLE = EATSTATICTWELVE_NUM_CELLS; // set the wavetable length to current wavetable
      break;   
      
    case 13:
      aSample.setTable(EATSTATICTHIRTEEN_DATA); // change the current wavetable
      CURRENT_TABLE = EATSTATICTHIRTEEN_NUM_CELLS; // set the wavetable length to current wavetable
      break;    
      
    case 14:
      aSample.setTable(EATSTATICFOURTEEN_DATA); // change the current wavetable
      CURRENT_TABLE = EATSTATICFOURTEEN_NUM_CELLS; // set the wavetable length to current wavetable
      break;  
      
    case 15:
      aSample.setTable(EATSTATICFIFTEEN_DATA); // change the current wavetable
      CURRENT_TABLE = EATSTATICFIFTEEN_NUM_CELLS; // set the wavetable length to current wavetable
      break;    
