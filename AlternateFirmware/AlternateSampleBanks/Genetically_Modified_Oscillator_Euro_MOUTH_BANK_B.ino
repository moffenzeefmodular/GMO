...
Sample <MOUTHNINE_NUM_CELLS, AUDIO_RATE> aSample(MOUTHNINE_DATA); // create the wavetable template 
...
*/
  ...
  */
  ...
  pitch = mapfloat(pitchMath, 1, 1023, 0.01, 10.0); // map from 0.01% to triple speed
  ...
  */
  ...
  switch (sampleSelect) {
    case 1:
      aSample.setTable(MOUTHEIGHTEEN_DATA); // change the current wavetable
      CURRENT_TABLE = MOUTHEIGHTEEN_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 2:
      aSample.setTable(MOUTHELEVEN_DATA); // change the current wavetable
      CURRENT_TABLE = MOUTHELEVEN_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 3:
      aSample.setTable(MOUTHFOURTEEN_DATA); // change the current wavetable
      CURRENT_TABLE = MOUTHFOURTEEN_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 4:
      aSample.setTable(MOUTHFIFTEEN_DATA); // change the current wavetable
      CURRENT_TABLE = MOUTHFIFTEEN_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 5:
      aSample.setTable(MOUTHSIXTEEN_DATA); // change the current wavetable
      CURRENT_TABLE = MOUTHSIXTEEN_NUM_CELLS; // set the wavetable length to current wavetable
      break;
      
    case 6:
      aSample.setTable(MOUTHSEVENTEEN_DATA); // change the current wavetable
      CURRENT_TABLE = MOUTHSEVENTEEN_NUM_CELLS; // set the wavetable length to current wavetable
      break;
      
    case 7:
      aSample.setTable(MOUTHNINETEEN_DATA); // change the current wavetable
      CURRENT_TABLE = MOUTHNINETEEN_NUM_CELLS; // set the wavetable length to current wavetable
      break;
      
    case 8:
      aSample.setTable(MOUTHTWENTY_DATA); // change the current wavetable
      CURRENT_TABLE = MOUTHTWENTY_NUM_CELLS; // set the wavetable length to current wavetable
      break;
