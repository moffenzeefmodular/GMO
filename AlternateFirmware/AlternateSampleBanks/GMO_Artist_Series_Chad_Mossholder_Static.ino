...
#include <samples/Wavetables/skta_int8.h> // Table for Sample
#include <samples/Wavetables/sktb_int8.h> // Table for Sample 
#include <samples/Wavetables/sktc_int8.h> // Table for Sample 
#include <samples/Wavetables/sktd_int8.h> // Table for Sample 
#include <samples/Wavetables/skte_int8.h> // Table for Sample 
#include <samples/Wavetables/sktf_int8.h> // Table for Sample
#include <samples/Wavetables/sktg_int8.h> // Table for Sample 
#include <samples/Wavetables/skth_int8.h> // Table for Sample

#define CONTROL_RATE 256 // powers of 2 please 

Sample <SKTA_NUM_CELLS, AUDIO_RATE> aSample(SKTA_DATA); // create the wavetable template 
...
*/
  ...
  */
  ...
  switch (sampleSelect) {
    case 1:
      aSample.setTable(SKTA_DATA); // change the current wavetable
      CURRENT_TABLE = SKTA_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 2:
      aSample.setTable(SKTB_DATA); // change the current wavetable
      CURRENT_TABLE = SKTB_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 3:
      aSample.setTable(SKTC_DATA); // change the current wavetable
      CURRENT_TABLE = SKTC_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 4:
      aSample.setTable(SKTD_DATA); // change the current wavetable
      CURRENT_TABLE = SKTD_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 5:
      aSample.setTable(SKTE_DATA); // change the current wavetable
      CURRENT_TABLE = SKTE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 6:
      aSample.setTable(SKTF_DATA); // change the current wavetable
      CURRENT_TABLE = SKTF_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 7:
      aSample.setTable(SKTG_DATA); // change the current wavetable
      CURRENT_TABLE = SKTG_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 8:
      aSample.setTable(SKTH_DATA); // change the current wavetable
      CURRENT_TABLE = SKTH_NUM_CELLS; // set the wavetable length to current wavetable
      break;
  }
