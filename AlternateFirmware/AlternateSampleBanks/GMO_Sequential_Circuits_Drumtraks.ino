...
#include <samples/wavetables/dtOne_int8.h> // Table for Sample
#include <samples/wavetables/dtTwo_int8.h> // Table for Sample 
#include <samples/wavetables/dtThree_int8.h> // Table for Sample 
#include <samples/wavetables/dtFour_int8.h> // Table for Sample 
#include <samples/wavetables/dtFive_int8.h> // Table for Sample
#include <samples/wavetables/dtSix_int8.h> // Table for Sample 
#include <samples/wavetables/dtSeven_int8.h> // Table for Sample 
#include <samples/wavetables/dtEight_int8.h> // Table for Sample 
...
Sample <DTONE_NUM_CELLS, AUDIO_RATE> aSample(DTONE_DATA); // create the wavetable template 
...
*/
  ...
  */
  ...
  switch (sampleSelect) {
    case 1:
      aSample.setTable(DTONE_DATA); // change the current wavetable
      CURRENT_TABLE = DTONE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 2:
      aSample.setTable(DTTWO_DATA); // change the current wavetable
      CURRENT_TABLE = DTTWO_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 3:
      aSample.setTable(DTTHREE_DATA); // change the current wavetable
      CURRENT_TABLE = DTTHREE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 4:
      aSample.setTable(DTFOUR_DATA); // change the current wavetable
      CURRENT_TABLE = DTFOUR_NUM_CELLS; // set the wavetable length to current wavetable
      break;
      
    case 5:
      aSample.setTable(DTFIVE_DATA); // change the current wavetable
      CURRENT_TABLE = DTFIVE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 6:
      aSample.setTable(DTSIX_DATA); // change the current wavetable
      CURRENT_TABLE = DTSIX_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 7:
      aSample.setTable(DTSEVEN_DATA); // change the current wavetable
      CURRENT_TABLE = DTSEVEN_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 8:
      aSample.setTable(DTEIGHT_DATA); // change the current wavetable
      CURRENT_TABLE = DTEIGHT_NUM_CELLS; // set the wavetable length to current wavetable
      break;  

    case 9:
      aSample.setTable(DTNINE_DATA); // change the current wavetable
      CURRENT_TABLE = DTNINE_NUM_CELLS; // set the wavetable length to current wavetable
      break;   
      
    case 10:
      aSample.setTable(DTTEN_DATA); // change the current wavetable
      CURRENT_TABLE = DTTEN_NUM_CELLS; // set the wavetable length to current wavetable
      break;  
