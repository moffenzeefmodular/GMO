...
#include <samples/Wavetables/kalimbaOne_int8.h> // Table for Sample
#include <samples/Wavetables/kalimbaTwo_int8.h> // Table for Sample 
#include <samples/Wavetables/kalimbaThree_int8.h> // Table for Sample 
#include <samples/Wavetables/kalimbaFour_int8.h> // Table for Sample 
#include <samples/Wavetables/kalimbaFive_int8.h> // Table for Sample 
#include <samples/Wavetables/kalimbaSix_int8.h> // Table for Sample
#include <samples/Wavetables/kalimbaSeven_int8.h> // Table for Sample 
#include <samples/Wavetables/kalimbaEight_int8.h> // Table for Sample 

#define CONTROL_RATE 256 // powers of 2 please 

Sample <KALIMBAONE_NUM_CELLS, AUDIO_RATE> aSample(KALIMBAONE_DATA); // create the wavetable template 
...
*/
  ...
  */
  ...
  switch (sampleSelect) {
    case 1:
      aSample.setTable(KALIMBAONE_DATA); // change the current wavetable
      CURRENT_TABLE = KALIMBAONE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 2:
      aSample.setTable(KALIMBATWO_DATA); // change the current wavetable
      CURRENT_TABLE = KALIMBATWO_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 3:
      aSample.setTable(KALIMBATHREE_DATA); // change the current wavetable
      CURRENT_TABLE = KALIMBATHREE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 4:
      aSample.setTable(KALIMBAFOUR_DATA); // change the current wavetable
      CURRENT_TABLE = KALIMBAFOUR_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 5:
      aSample.setTable(KALIMBAFIVE_DATA); // change the current wavetable
      CURRENT_TABLE = KALIMBAFIVE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 6:
      aSample.setTable(KALIMBASIX_DATA); // change the current wavetable
      CURRENT_TABLE = KALIMBASIX_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 7:
      aSample.setTable(KALIMBASEVEN_DATA); // change the current wavetable
      CURRENT_TABLE = KALIMBASEVEN_NUM_CELLS; // set the wavetable length to current wavetable
      break;
      
    case 8:
      aSample.setTable(KALIMBAEIGHT_DATA); // change the current wavetable
      CURRENT_TABLE = KALIMBAEIGHT_NUM_CELLS; // set the wavetable length to current wavetable
      break;
