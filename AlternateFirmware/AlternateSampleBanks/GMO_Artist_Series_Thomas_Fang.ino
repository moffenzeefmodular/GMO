...
#include <samples/Wavetables/fangOne_int8.h> // Table for Sample
#include <samples/Wavetables/fangTwo_int8.h> // Table for Sample 
#include <samples/Wavetables/fangThree_int8.h> // Table for Sample 
#include <samples/Wavetables/fangFour_int8.h> // Table for Sample 
#include <samples/Wavetables/fangFive_int8.h> // Table for Sample 
#include <samples/Wavetables/fangSix_int8.h> // Table for Sample
#include <samples/Wavetables/fangSeven_int8.h> // Table for Sample 
#include <samples/Wavetables/fangEight_int8.h> // Table for Sample
#include <samples/Wavetables/fangNine_int8.h> // Table for Sample

#define CONTROL_RATE 256 // powers of 2 please 

Sample <FANGONE_NUM_CELLS, AUDIO_RATE> aSample(FANGONE_DATA); // create the wavetable template 
...
*/
  ...
  */
  ...
  switch (sampleSelect) {
    case 1:
      aSample.setTable(FANGONE_DATA); // change the current wavetable
      CURRENT_TABLE = FANGONE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 2:
      aSample.setTable(FANGTWO_DATA); // change the current wavetable
      CURRENT_TABLE = FANGTWO_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 3:
      aSample.setTable(FANGTHREE_DATA); // change the current wavetable
      CURRENT_TABLE = FANGTHREE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 4:
      aSample.setTable(FANGFOUR_DATA); // change the current wavetable
      CURRENT_TABLE = FANGFOUR_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 5:
      aSample.setTable(FANGFIVE_DATA); // change the current wavetable
      CURRENT_TABLE = FANGFIVE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 6:
      aSample.setTable(FANGSIX_DATA); // change the current wavetable
      CURRENT_TABLE = FANGSIX_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 7:
      aSample.setTable(FANGSEVEN_DATA); // change the current wavetable
      CURRENT_TABLE = FANGSEVEN_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 8:
      aSample.setTable(FANGEIGHT_DATA); // change the current wavetable
      CURRENT_TABLE = FANGEIGHT_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 9:
      aSample.setTable(FANGNINE_DATA); // change the current wavetable
      CURRENT_TABLE = FANGNINE_NUM_CELLS; // set the wavetable length to current wavetable
      break;
  }
