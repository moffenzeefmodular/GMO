...
Sample <METALONE_NUM_CELLS, AUDIO_RATE> aSample(METALONE_DATA); // create the wavetable template 
...
*/
  ...
  */
  ...
  switch (sampleSelect) {
    case 1:
      aSample.setTable(METALONE_DATA); // change the current wavetable
      CURRENT_TABLE = METALONE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 2:
      aSample.setTable(METALTWO_DATA); // change the current wavetable
      CURRENT_TABLE = METALTWO_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 3:
      aSample.setTable(METALTHREE_DATA); // change the current wavetable
      CURRENT_TABLE = METALTHREE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 4:
      aSample.setTable(METALFOUR_DATA); // change the current wavetable
      CURRENT_TABLE = METALFOUR_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 5:
      aSample.setTable(METALFIVE_DATA); // change the current wavetable
      CURRENT_TABLE = METALFIVE_NUM_CELLS; // set the wavetable length to current wavetable
      break;
      
    case 6:
      aSample.setTable(METALSIX_DATA); // change the current wavetable
      CURRENT_TABLE = METALSIX_NUM_CELLS; // set the wavetable length to current wavetable
      break;
      
    case 7:
      aSample.setTable(METALSEVEN_DATA); // change the current wavetable
      CURRENT_TABLE = METALSEVEN_NUM_CELLS; // set the wavetable length to current wavetable
      break;
      
    case 8:
      aSample.setTable(METALEIGHT_DATA); // change the current wavetable
      CURRENT_TABLE = METALEIGHT_NUM_CELLS; // set the wavetable length to current wavetable
      break;
