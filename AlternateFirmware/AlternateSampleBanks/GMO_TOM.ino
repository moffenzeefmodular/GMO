...
Sample <TOMONE_NUM_CELLS, AUDIO_RATE> aSample(TOMONE_DATA); // create the wavetable template 
...
*/
  ...
  */
  ...
  switch (sampleSelect) {
    case 1:
      aSample.setTable(TOMONE_DATA); // change the current wavetable
      CURRENT_TABLE = TOMONE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 2:
      aSample.setTable(TOMTWO_DATA); // change the current wavetable
      CURRENT_TABLE = TOMTWO_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 3:
      aSample.setTable(TOMTHREE_DATA); // change the current wavetable
      CURRENT_TABLE = TOMTHREE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 4:
      aSample.setTable(TOMFOUR_DATA); // change the current wavetable
      CURRENT_TABLE = TOMFOUR_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 5:
      aSample.setTable(TOMFIVE_DATA); // change the current wavetable
      CURRENT_TABLE = TOMFIVE_NUM_CELLS; // set the wavetable length to current wavetable
      break;
      
    case 6:
      aSample.setTable(TOMSIX_DATA); // change the current wavetable
      CURRENT_TABLE = TOMSIX_NUM_CELLS; // set the wavetable length to current wavetable
      break;
      
    case 7:
      aSample.setTable(TOMSEVEN_DATA); // change the current wavetable
      CURRENT_TABLE = TOMSEVEN_NUM_CELLS; // set the wavetable length to current wavetable
      break;
      
    case 8:
      aSample.setTable(TOMEIGHT_DATA); // change the current wavetable
      CURRENT_TABLE = TOMEIGHT_NUM_CELLS; // set the wavetable length to current wavetable
      break;
