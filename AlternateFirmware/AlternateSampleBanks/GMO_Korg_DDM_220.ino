...
#include <samples/wavetables/ddmOne_int8.h> // Table for Sample
#include <samples/wavetables/ddmTwo_int8.h> // Table for Sample 
#include <samples/wavetables/ddmThree_int8.h> // Table for Sample 
#include <samples/wavetables/ddmFour_int8.h> // Table for Sample 
#include <samples/wavetables/ddmFive_int8.h> // Table for Sample
#include <samples/wavetables/ddmSix_int8.h> // Table for Sample 
#include <samples/wavetables/ddmSeven_int8.h> // Table for Sample 
#include <samples/wavetables/ddmEight_int8.h> // Table for Sample 

#define CONTROL_RATE 256 // powers of 2 please 

Sample <DDMONE_NUM_CELLS, AUDIO_RATE> aSample(DDMONE_DATA); // create the wavetable template 
...
*/
  ...
  */
  ...
  switch (sampleSelect) {
    case 1:
      aSample.setTable(DDMONE_DATA); // change the current wavetable
      CURRENT_TABLE = DDMONE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 2:
      aSample.setTable(DDMTWO_DATA); // change the current wavetable
      CURRENT_TABLE = DDMTWO_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 3:
      aSample.setTable(DDMTHREE_DATA); // change the current wavetable
      CURRENT_TABLE = DDMTHREE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 4:
      aSample.setTable(DDMFOUR_DATA); // change the current wavetable
      CURRENT_TABLE = DDMFOUR_NUM_CELLS; // set the wavetable length to current wavetable
      break;
      
    case 5:
      aSample.setTable(DDMFIVE_DATA); // change the current wavetable
      CURRENT_TABLE = DDMFIVE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 6:
      aSample.setTable(DDMSIX_DATA); // change the current wavetable
      CURRENT_TABLE = DDMSIX_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 7:
      aSample.setTable(DDMSEVEN_DATA); // change the current wavetable
      CURRENT_TABLE = DDMSEVEN_NUM_CELLS; // set the wavetable length to current wavetable
      break;
      
    case 8:
      aSample.setTable(DDMEIGHT_DATA); // change the current wavetable
      CURRENT_TABLE = DDMEIGHT_NUM_CELLS; // set the wavetable length to current wavetable
      break;
  }
