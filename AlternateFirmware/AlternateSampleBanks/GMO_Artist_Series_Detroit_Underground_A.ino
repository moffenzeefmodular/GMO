...
#include <samples/wavetables/duOne_int8.h> // Table for Sample
#include <samples/wavetables/duTwo_int8.h> // Table for Sample 
#include <samples/wavetables/duThree_int8.h> // Table for Sample 
#include <samples/wavetables/duFour_int8.h> // Table for Sample 
#include <samples/wavetables/duFive_int8.h> // Table for Sample
#include <samples/wavetables/duSix_int8.h> // Table for Sample 
#include <samples/wavetables/duSeven_int8.h> // Table for Sample 
#include <samples/wavetables/duEight_int8.h> // Table for Sample 
#include <samples/wavetables/duNine_int8.h> // Table for Sample 
#include <samples/wavetables/duTen_int8.h> // Table for Sample 
#include <samples/wavetables/duEleven_int8.h> // Table for Sample 
#include <samples/wavetables/duTwelve_int8.h> // Table for Sample 
#include <samples/wavetables/duThirteen_int8.h> // Table for Sample 


#define CONTROL_RATE 256 // powers of 2 please 

Sample <DUONE_NUM_CELLS, AUDIO_RATE> aSample(DUONE_DATA); // create the wavetable template 
...
*/
  ...
  */
  ...
  pitch = mapfloat(pitchMath, 1, 1023, 3.0, 8.0); // map from 0.01% to triple speed
  ...
  */
  ...
  sampleSelect = map(sampleMath, 1, 1023, 1, 14); 
  ...
  */
  ...
  switch (sampleSelect) {
    case 1:
      aSample.setTable(DUONE_DATA); // change the current wavetable
      CURRENT_TABLE = DUONE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 2:
      aSample.setTable(DUTWO_DATA); // change the current wavetable
      CURRENT_TABLE = DUTWO_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 3:
      aSample.setTable(DUTHREE_DATA); // change the current wavetable
      CURRENT_TABLE = DUTHREE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 4:
      aSample.setTable(DUFOUR_DATA); // change the current wavetable
      CURRENT_TABLE = DUFOUR_NUM_CELLS; // set the wavetable length to current wavetable
      break;
      
    case 5:
      aSample.setTable(DUFIVE_DATA); // change the current wavetable
      CURRENT_TABLE = DUFIVE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 6:
      aSample.setTable(DUSIX_DATA); // change the current wavetable
      CURRENT_TABLE = DUSIX_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 7:
      aSample.setTable(DUSEVEN_DATA); // change the current wavetable
      CURRENT_TABLE = DUSEVEN_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 8:
      aSample.setTable(DUEIGHT_DATA); // change the current wavetable
      CURRENT_TABLE = DUEIGHT_NUM_CELLS; // set the wavetable length to current wavetable
      break;  

    case 9:
      aSample.setTable(DUNINE_DATA); // change the current wavetable
      CURRENT_TABLE = DUNINE_NUM_CELLS; // set the wavetable length to current wavetable
      break;   
      
    case 10:
      aSample.setTable(DUTEN_DATA); // change the current wavetable
      CURRENT_TABLE = DUTEN_NUM_CELLS; // set the wavetable length to current wavetable
      break;  
      
    case 11:
      aSample.setTable(DUELEVEN_DATA); // change the current wavetable
      CURRENT_TABLE = DUELEVEN_NUM_CELLS; // set the wavetable length to current wavetable
      break;   
      
    case 12:
      aSample.setTable(DUTWELVE_DATA); // change the current wavetable
      CURRENT_TABLE = DUTWELVE_NUM_CELLS; // set the wavetable length to current wavetable
      break;   
      
    case 13:
      aSample.setTable(DUTHIRTEEN_DATA); // change the current wavetable
      CURRENT_TABLE = DUTHIRTEEN_NUM_CELLS; // set the wavetable length to current wavetable
      break;    
