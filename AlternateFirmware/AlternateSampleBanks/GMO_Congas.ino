...
#include <samples/wavetables/congaOne_int8.h> // Table for Sample
#include <samples/wavetables/congaTwo_int8.h> // Table for Sample 
#include <samples/wavetables/congaThree_int8.h> // Table for Sample 
#include <samples/wavetables/congaFour_int8.h> // Table for Sample 
#include <samples/wavetables/congaFive_int8.h> // Table for Sample 
#include <samples/wavetables/congaSix_int8.h> // Table for Sample
#include <samples/wavetables/congaSeven_int8.h> // Table for Sample 
#include <samples/wavetables/congaEight_int8.h> // Table for Sample
#include <samples/wavetables/congaNine_int8.h> // Table for Sample
#include <samples/wavetables/congaTen_int8.h> // Table for Sample
#include <samples/wavetables/congaEleven_int8.h> // Table for Sample
#include <samples/wavetables/congaTwelve_int8.h> // Table for Sample

#define CONTROL_RATE 256 // powers of 2 please 

Sample <CONGAONE_NUM_CELLS, AUDIO_RATE> aSample(CONGAONE_DATA); // create the wavetable template 
...
*/
  ...
  */
  ...
  pitch = mapfloat(pitchMath, 1, 1023, 8.0, 20.0); // map from 0.01% to triple speed
  ...
  */
  ...
  sampleSelect = map(sampleMath, 1, 1023, 1, 13); 
  ...
  */
  ...
  switch (sampleSelect) {
    case 1:
      aSample.setTable(CONGAONE_DATA); // change the current wavetable
      CURRENT_TABLE = CONGAONE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 2:
      aSample.setTable(CONGATWO_DATA); // change the current wavetable
      CURRENT_TABLE = CONGATWO_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 3:
      aSample.setTable(CONGATHREE_DATA); // change the current wavetable
      CURRENT_TABLE = CONGATHREE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 4:
      aSample.setTable(CONGAFOUR_DATA); // change the current wavetable
      CURRENT_TABLE = CONGAFOUR_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 5:
      aSample.setTable(CONGAFIVE_DATA); // change the current wavetable
      CURRENT_TABLE = CONGAFIVE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 6:
      aSample.setTable(CONGASIX_DATA); // change the current wavetable
      CURRENT_TABLE = CONGASIX_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 7:
      aSample.setTable(CONGASEVEN_DATA); // change the current wavetable
      CURRENT_TABLE = CONGASEVEN_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 8:
      aSample.setTable(CONGAEIGHT_DATA); // change the current wavetable
      CURRENT_TABLE = CONGAEIGHT_NUM_CELLS; // set the wavetable length to current wavetable
      break;
  
    case 9:
      aSample.setTable(CONGANINE_DATA); // change the current wavetable
      CURRENT_TABLE = CONGANINE_NUM_CELLS; // set the wavetable length to current wavetable
      break;
      
    case 10:
      aSample.setTable(CONGATEN_DATA); // change the current wavetable
      CURRENT_TABLE = CONGATEN_NUM_CELLS; // set the wavetable length to current wavetable
      break;
      
    case 11:
      aSample.setTable(CONGAELEVEN_DATA); // change the current wavetable
      CURRENT_TABLE = CONGAELEVEN_NUM_CELLS; // set the wavetable length to current wavetable
      break;
      
    case 12:
      aSample.setTable(CONGATWELVE_DATA); // change the current wavetable
      CURRENT_TABLE = CONGATWELVE_NUM_CELLS; // set the wavetable length to current wavetable
      break;    
  }
