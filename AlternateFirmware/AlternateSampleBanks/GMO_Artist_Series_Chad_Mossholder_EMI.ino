...
#include <samples/Wavetables/emi_1_int8.h> // Table for Sample
#include <samples/Wavetables/emi_2_int8.h> // Table for Sample 
#include <samples/Wavetables/emi_3_int8.h> // Table for Sample 
#include <samples/Wavetables/emi_4_int8.h> // Table for Sample 
#include <samples/Wavetables/emi_5_int8.h> // Table for Sample 
#include <samples/Wavetables/emi_6_int8.h> // Table for Sample
#include <samples/Wavetables/emi_7_int8.h> // Table for Sample 
#include <samples/Wavetables/emi_8_int8.h> // Table for Sample

#define CONTROL_RATE 256 // powers of 2 please 

Sample <EMI_1_NUM_CELLS, AUDIO_RATE> aSample(EMI_1_DATA); // create the wavetable template 
...
*/
  ...
  */
  ...
  switch (sampleSelect) {
    case 1:
      aSample.setTable(EMI_1_DATA); // change the current wavetable
      CURRENT_TABLE = EMI_1_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 2:
      aSample.setTable(EMI_2_DATA); // change the current wavetable
      CURRENT_TABLE = EMI_2_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 3:
      aSample.setTable(EMI_3_DATA); // change the current wavetable
      CURRENT_TABLE = EMI_3_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 4:
      aSample.setTable(EMI_4_DATA); // change the current wavetable
      CURRENT_TABLE = EMI_4_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 5:
      aSample.setTable(EMI_5_DATA); // change the current wavetable
      CURRENT_TABLE = EMI_5_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 6:
      aSample.setTable(EMI_6_DATA); // change the current wavetable
      CURRENT_TABLE = EMI_6_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 7:
      aSample.setTable(EMI_7_DATA); // change the current wavetable
      CURRENT_TABLE = EMI_7_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 8:
      aSample.setTable(EMI_8_DATA); // change the current wavetable
      CURRENT_TABLE = EMI_8_NUM_CELLS; // set the wavetable length to current wavetable
      break;
  }
