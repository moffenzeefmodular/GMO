...
#include <samples/wavetables/edrumOne_int8.h> // Table for Sample
#include <samples/wavetables/edrumTwo_int8.h> // Table for Sample 
#include <samples/wavetables/edrumThree_int8.h> // Table for Sample 
#include <samples/wavetables/edrumFour_int8.h> // Table for Sample 
#include <samples/wavetables/edrumFive_int8.h> // Table for Sample
#include <samples/wavetables/edrumSix_int8.h> // Table for Sample 
#include <samples/wavetables/edrumSeven_int8.h> // Table for Sample 
#include <samples/wavetables/edrumNine_int8.h> // Table for Sample 
#include <samples/wavetables/edrumTen_int8.h> // Table for Sample 
#include <samples/wavetables/edrumEleven_int8.h> // Table for Sample 
#include <samples/wavetables/edrumTwelve_int8.h> // Table for Sample 
#include <samples/wavetables/edrumThirteen_int8.h> // Table for Sample 
#include <samples/wavetables/edrumFourteen_int8.h> // Table for Sample 


#define CONTROL_RATE 256 // powers of 2 please 

Sample <EDRUMONE_NUM_CELLS, AUDIO_RATE> aSample(EDRUMONE_DATA); // create the wavetable template 
...
*/
  ...
  */
  ...
  pitch = mapfloat(pitchMath, 1, 1023, 5.0, 20.0); // map from 0.01% to triple speed
  ...
  */
  ...
  switch (sampleSelect) {
    case 1:
      aSample.setTable(EDRUMONE_DATA); // change the current wavetable
      CURRENT_TABLE = EDRUMONE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 2:
      aSample.setTable(EDRUMTWO_DATA); // change the current wavetable
      CURRENT_TABLE = EDRUMTWO_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 3:
      aSample.setTable(EDRUMTHREE_DATA); // change the current wavetable
      CURRENT_TABLE = EDRUMTHREE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 4:
      aSample.setTable(EDRUMFOUR_DATA); // change the current wavetable
      CURRENT_TABLE = EDRUMFOUR_NUM_CELLS; // set the wavetable length to current wavetable
      break;
      
    case 5:
      aSample.setTable(EDRUMFIVE_DATA); // change the current wavetable
      CURRENT_TABLE = EDRUMFIVE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 6:
      aSample.setTable(EDRUMSIX_DATA); // change the current wavetable
      CURRENT_TABLE = EDRUMSIX_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 7:
      aSample.setTable(EDRUMSEVEN_DATA); // change the current wavetable
      CURRENT_TABLE = EDRUMSEVEN_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 8:
      aSample.setTable(EDRUMNINE_DATA); // change the current wavetable
      CURRENT_TABLE = EDRUMNINE_NUM_CELLS; // set the wavetable length to current wavetable
      break;   
      
    case 9:
      aSample.setTable(EDRUMTEN_DATA); // change the current wavetable
      CURRENT_TABLE = EDRUMTEN_NUM_CELLS; // set the wavetable length to current wavetable
      break;  
      
    case 10:
      aSample.setTable(EDRUMELEVEN_DATA); // change the current wavetable
      CURRENT_TABLE = EDRUMELEVEN_NUM_CELLS; // set the wavetable length to current wavetable
      break;   
      
    case 11:
      aSample.setTable(EDRUMTWELVE_DATA); // change the current wavetable
      CURRENT_TABLE = EDRUMTWELVE_NUM_CELLS; // set the wavetable length to current wavetable
      break;    
      
    case 12:
      aSample.setTable(EDRUMTHIRTEEN_DATA); // change the current wavetable
      CURRENT_TABLE = EDRUMTHIRTEEN_NUM_CELLS; // set the wavetable length to current wavetable
      break;   
     
    case 13:
      aSample.setTable(EDRUMFOURTEEN_DATA); // change the current wavetable
      CURRENT_TABLE = EDRUMFOURTEEN_NUM_CELLS; // set the wavetable length to current wavetable
      break;           
  }
