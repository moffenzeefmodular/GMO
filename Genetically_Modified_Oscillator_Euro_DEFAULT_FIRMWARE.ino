...
Sample <BELLONE_NUM_CELLS, AUDIO_RATE> aSample(BELLONE_DATA); // create the wavetable template 
...
*/
  ...
  */
  ...
  switch (sampleSelect) {
    case 1:
      aSample.setTable(BELLONE_DATA); // change the current wavetable
      CURRENT_TABLE = BELLONE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 2:
      aSample.setTable(BELLTWO_DATA); // change the current wavetable
      CURRENT_TABLE = BELLTWO_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 3:
      aSample.setTable(BELLTHREE_DATA); // change the current wavetable
      CURRENT_TABLE = BELLTHREE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 4:
      aSample.setTable(BELLFOUR_DATA); // change the current wavetable
      CURRENT_TABLE = BELLFOUR_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 5:
      aSample.setTable(BELLFIVE_DATA); // change the current wavetable
      CURRENT_TABLE = BELLFIVE_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 6:
      aSample.setTable(BELLSIX_DATA); // change the current wavetable
      CURRENT_TABLE = BELLSIX_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 7:
      aSample.setTable(BELLSEVEN_DATA); // change the current wavetable
      CURRENT_TABLE = BELLSEVEN_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 8:
      aSample.setTable(BELLEIGHT_DATA); // change the current wavetable
      CURRENT_TABLE = BELLEIGHT_NUM_CELLS; // set the wavetable length to current wavetable
      break;
  }
